...
/* FILE NAME:  linuxbt_gatt_if.h
 * AUTHOR: Xuemei Yang
 * PURPOSE:
 *      It provides GATT common initialization and operation interface definition to MW.
 * NOTES:
 */
...
#ifndef __LINUXBT_GATT_IF_H__
#define __LINUXBT_GATT_IF_H__
