...
static void _linuxbt_mesh_health_client_evt_handler_wrapper(uint16_t model_handle, const meshif_access_message_rx_t *msg, const meshif_health_client_evt_t *event)
{
...
static void _linuxbt_mesh_model_access_msg_dispatch(uint16_t model_handle, const meshif_access_message_rx_t *msg, const void *arg)
{
...
static void _linuxbt_mesh_bt_event_handler(meshif_bt_evt_t *evt)
{
    ...
    switch (evt->evt_id)
    {
        ...
        {
            event.evt.mesh_evt.mesh.prov_factor.type = evt->evt.mesh_evt.mesh.prov_factor.type;
        ...
        case MESHIF_EVT_ADV_REPORT:
        {
            ...
            event.evt.mesh_evt.mesh.adv_report.type = evt->evt.mesh_evt.mesh.adv_report.type;
            ...
            event.evt.mesh_evt.mesh.adv_report.peer_addr.addr_type = evt->evt.mesh_evt.mesh.adv_report.peer_addr.addr_type;
        ...
        case MESHIF_EVT_KEY_REFRESH:
        {
            ...
            event.evt.mesh_evt.mesh.key_refresh.phase = evt->evt.mesh_evt.mesh.key_refresh.phase;
            break;
        }
        ...
        case MESHIF_EVT_IV_UPDATE:
        {
            ...
            event.evt.mesh_evt.mesh.iv_update.state = evt->evt.mesh_evt.mesh.iv_update.state;
        ...
        {
            event.evt.mesh_evt.mesh.ota_evt.event_id = evt->evt.mesh_evt.mesh.ota_evt.event_id;
            event.evt.mesh_evt.mesh.ota_evt.error_code = evt->evt.mesh_evt.mesh.ota_evt.error_code;
            ...
            event.evt.mesh_evt.mesh.ota_evt.nodes_status = evt->evt.mesh_evt.mesh.ota_evt.nodes_status;
            break;
        }
        case MESHIF_EVT_FRIENDSHIP_STATUS:
        {
            ...
            event.evt.mesh_evt.mesh.friendship_status.status = evt->evt.mesh_evt.mesh.friendship_status.status;
            break;
        }
        case MESHIF_EVT_BEARER_GATT_STATUS:
        {
            ...
            event.evt.mesh_evt.mesh.bearer_gatt_status.status = evt->evt.mesh_evt.mesh.bearer_gatt_status.status;
            break;
        }
        case MESHIF_EVT_ERROR_CODE:
        {
            event.evt.mesh_evt.mesh.error_code.type = evt->evt.mesh_evt.mesh.error_code.type;
            break;
        }
...
INT32 linuxbt_mesh_enable(const BT_MESH_INIT_PARAMS_T *init_params)
{
...
INT32 linuxbt_mesh_invite_provisioning(const UINT8 *target_uuid, const BT_MESH_PROV_INVITE_T *invite)
{
...
INT32 linuxbt_mesh_start_provisioning(const BT_MESH_PROV_PROVISIONER_PARAMS_T *params, UINT8 mode)
{
...
INT32 linuxbt_mesh_set_prov_factor(const BT_MESH_PROV_FACTOR_T *factor)
{
...
INT32 linuxbt_mesh_model_cc_msg_tx(const BT_MESH_CONFIGURATION_MSG_TX_T *msg)
{
...
INT32 linuxbt_mesh_send_packet(const BT_MESH_TX_PARAMS_T *params)
{
...
INT32 linuxbt_mesh_send_packet_ex(const BT_MESH_TX_PARAMS_T *params, BT_MESH_MODEL_OPERATION_T *model_op)
{
    meshif_tx_params_t tx_params;
...
INT32 linuxbt_mesh_access_model_reply(UINT16 model_handle, const BT_MESH_ACCESS_MESSAGE_RX_T *msg, const BT_MESH_ACCESS_MESSAGE_TX_T *reply)
{
...
INT32 linuxbt_mesh_bearer_adv_set_params(const BT_MESH_BEARER_ADV_PARAMS_T *adv_params, const BT_MESH_BEARER_SCAN_PARAMS_T *scan_params)
{
...
{
    return meshif_set_mesh_mode(mode);
}
