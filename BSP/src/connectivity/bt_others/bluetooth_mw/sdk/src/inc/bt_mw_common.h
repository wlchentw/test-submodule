...
#define BLUETOOTH_RM_BT_CONFIG_CMD      "rm -rf "BLUETOOTH_STACK_LOCAL_FOLDER"/bt_config.*"
#define BLUETOOTH_RM_BT_SNOOP_HCI_CMD   "rm -rf "BLUETOOTH_STACK_LOCAL_FOLDER"/bt_btsnoop*"
#define BLUETOOTH_RM_BT_STACK_LOG_CMD   "rm -rf "BLUETOOTH_STACK_LOCAL_FOLDER"/bt_stack.log"
#define BLUETOOTH_RM_BAK_FILE_CMD       "rm -rf "BLUETOOTH_STACK_LOCAL_FOLDER"/*.bak"
#define BLUETOOTH_RM_BT_PROPERTY_CMD    "rm -rf "BT_MISC_PATH"bt_property"
