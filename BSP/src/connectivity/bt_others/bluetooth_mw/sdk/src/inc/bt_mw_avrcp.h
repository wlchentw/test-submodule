...
enum
{
    ...
    BTMW_AVRCP_GET_FOLDER_ITEMS_REQ,
...

{
    ...
    BT_AVRCP_FOLDER_TYPE folder_items[BT_AVRCP_MAX_ATTR_CNT];

    INT32 attr_cnt;
    CHAR player_name[16];

}BT_AVRCP_GET_FOLDER_ITEMS_REQ;
...
#define BT_MW_AVRCP_CASE_RETURN_STR(_const,str) case _const: return str
...
typedef struct BT_MW_AVRCP_MSG
{
	...
	BT_AVRCP_GET_FOLDER_ITEMS_REQ get_folder_items_req;
