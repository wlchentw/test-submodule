...
VOID bt_gatt_init_profile(VOID)
{
    linuxbt_gatt_init();
    return;
}
...
static VOID bt_mw_gatt_notify_thread_exit()
{
...
VOID bt_gatt_deinit_profile(VOID)
{
...
{
    FUNC_ENTRY;
    if (-1 == msgctl(bt_gatt_nty_msg_queue_id, IPC_RMID, NULL))
    {
