...
EXPORT_SYMBOL INT32 c_btm_a2dp_src_active_sink(CHAR *addr, BOOL active)
{
    bt_mw_a2dp_src_active_sink(addr, active);
    return BT_SUCCESS;
}
...
EXPORT_SYMBOL INT32 c_btm_a2dp_src_uploader_load(CHAR* uploader_so_path)
{
    ...
    bt_mw_a2dp_src_uploader_load(uploader_so_path);
}
