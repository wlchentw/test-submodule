...
EXPORT_SYMBOL INT32 c_btm_get_properties(VOID)
{
    FUNC_ENTRY;
    return bt_mw_get_properties();
}
...
EXPORT_SYMBOL INT32 c_btm_get_bonded_device(VOID)
{
    return bt_mw_get_bonded_device();
}
...
EXPORT_SYMBOL INT32 c_btm_set_lhdc_key_data(CHAR *name, UINT8 *data, INT32 data_len)
{
    FUNC_ENTRY;
    return bt_mw_set_lhdc_key_data(name, data, data_len);
}
...
EXPORT_SYMBOL INT32 c_btm_get_bond_state(CHAR* bd_addr)
{
    FUNC_ENTRY;
