...
LOCAL_C_INCLUDES := \
        ...
        $(LOCAL_PATH)/../../mw/bt/bt_mw/src/a2dp/snk/playback/ALSA    \
        $(LOCAL_PATH)/../inc

LOCAL_MODULE := btmw-test
LOCAL_STATIC_LIBRARIES := btmw-test_gap btmw-test_gatt btmw-test_hid btmw-test_avrcp btmw-test_a2dp btmw-test_spp btmw-test_mesh btmw-test_tools libbtmw_avrcp
LOCAL_SHARED_LIBRARIES := libbt-mw libbt-alsa-playback
