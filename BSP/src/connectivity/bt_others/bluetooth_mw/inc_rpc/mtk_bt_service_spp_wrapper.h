 ...
 *      None
 */
extern INT32 a_mtkapi_spp_connect(CHAR* addr, CHAR* uuid);
 ...
 *      None
 */
extern INT32 a_mtkapi_spp_disconnect(CHAR *addr, CHAR *uuid);
 ...
 *      None
 */
extern INT32 a_mtkapi_spp_send_data(CHAR* addr, CHAR *uuid, CHAR* str, INT32 len);
 ...
 *      None
 */
extern INT32 a_mtkapi_spp_start_server(CHAR *servername, CHAR* uuid);
 ...
 */
extern INT32 a_mtkapi_spp_stop_server(CHAR *uuid);
