...
INT32 x_mtkapi_spp_start_server(CHAR *servername, CHAR* uuid)
{
    INT32 i4_ret = 0;
    i4_ret = c_btm_spp_start_server(servername, uuid);
    if (i4_ret != 0)
    {
...
INT32 x_mtkapi_spp_stop_server(CHAR *uuid)
{
    INT32 i4_ret = 0;
    i4_ret = c_btm_spp_stop_server(uuid);
    if (i4_ret != 0)
    {
