 ...
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_set_link_num(INT32 local_src_num, INT32 local_sink_num)
{
    BT_A2DP_WRAPPER_LOG("");
    RPC_CLIENT_DECL(2, INT32);

    RPC_CLIENT_ARG_INP(ARG_TYPE_INT32, local_src_num);
    RPC_CLIENT_ARG_INP(ARG_TYPE_INT32, local_sink_num);

    RPC_BT_SERVICE_CLIENT_DO_OP("x_mtkapi_a2dp_set_link_num");
    RPC_CLIENT_RETURN(ARG_TYPE_INT32, -1);
}
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_sink_active_src(CHAR *addr, BOOL active)
{
    BT_A2DP_WRAPPER_LOG("");
    RPC_CLIENT_DECL(2, INT32);

    RPC_CLIENT_ARG_INP(ARG_TYPE_REF_STR, addr);
    RPC_CLIENT_ARG_INP(ARG_TYPE_INT32, active);
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_sink_player_load(CHAR* player_so_path)
{
    BT_A2DP_WRAPPER_LOG("");
    RPC_CLIENT_DECL(1, INT32);

    RPC_CLIENT_ARG_INP(ARG_TYPE_REF_STR, player_so_path);

    RPC_BT_SERVICE_CLIENT_DO_OP("x_mtkapi_a2dp_sink_player_load");
    RPC_CLIENT_RETURN(ARG_TYPE_INT32, -1);
}
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_sink_player_unload(CHAR *player_name)
{
    BT_A2DP_WRAPPER_LOG("");
    RPC_CLIENT_DECL(1, INT32);

    RPC_CLIENT_ARG_INP(ARG_TYPE_REF_STR, player_name);

    RPC_BT_SERVICE_CLIENT_DO_OP("x_mtkapi_a2dp_sink_player_unload");
    RPC_CLIENT_RETURN(ARG_TYPE_INT32, -1);
}

/* FUNCTION NAME: c_btm_a2dp_src_active_sink
 * PURPOSE:
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_src_active_sink(CHAR *addr, BOOL active)
{
    BT_A2DP_WRAPPER_LOG("");
    RPC_CLIENT_DECL(2, INT32);
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_src_pause_uploader(VOID)
{
    BT_A2DP_WRAPPER_LOG("");
    INT32 tmp = 0;
    RPC_CLIENT_DECL(1, INT32);
    RPC_CLIENT_ARG_INP(ARG_TYPE_INT32, tmp);
    RPC_BT_SERVICE_CLIENT_DO_OP("x_mtkapi_a2dp_src_pause_uploader");
    RPC_CLIENT_RETURN(ARG_TYPE_INT32, -1);
}
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_src_resume_uploader(VOID)
{
    BT_A2DP_WRAPPER_LOG("");
    INT32 tmp = 0;
    RPC_CLIENT_DECL(1, INT32);
    RPC_CLIENT_ARG_INP(ARG_TYPE_INT32, tmp);
    RPC_BT_SERVICE_CLIENT_DO_OP("x_mtkapi_a2dp_src_resume_uploader");
    RPC_CLIENT_RETURN(ARG_TYPE_INT32, -1);
}
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_src_mute_uploader(BOOL mute)
{
    BT_A2DP_WRAPPER_LOG("");
    RPC_CLIENT_DECL(1, UINT8);

    RPC_CLIENT_ARG_INP(ARG_TYPE_UINT8, mute);

    RPC_BT_SERVICE_CLIENT_DO_OP("x_mtkapi_a2dp_src_mute_uploader");
    RPC_CLIENT_RETURN(ARG_TYPE_INT32, -1);
}
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_src_uploader_load(CHAR* uploader_so_path)
{
    BT_A2DP_WRAPPER_LOG("");
    RPC_CLIENT_DECL(1, INT32);

    RPC_CLIENT_ARG_INP(ARG_TYPE_REF_STR, uploader_so_path);

    RPC_BT_SERVICE_CLIENT_DO_OP("x_mtkapi_a2dp_src_uploader_load");
    RPC_CLIENT_RETURN(ARG_TYPE_INT32, -1);
}
 ...
 *      N/A
 */
EXPORT_SYMBOL INT32 a_mtkapi_a2dp_src_uploader_unload(CHAR *uploader_name)
{
    BT_A2DP_WRAPPER_LOG("");
    RPC_CLIENT_DECL(1, INT32);

    RPC_CLIENT_ARG_INP(ARG_TYPE_REF_STR, uploader_name);

    RPC_BT_SERVICE_CLIENT_DO_OP("x_mtkapi_a2dp_src_uploader_unload");
    RPC_CLIENT_RETURN(ARG_TYPE_INT32, -1);
}
