...
/* tool 'MTK RPC Description tool', 'Version 1.10' on 'Thu Sep  5 22:03:30 2019'. */
...
#define RPC_DESC_BLUETOOTH_DEVICE  (__rpc_get_spp_desc__ (0))


#define RPC_DESC_BT_SPP_CBK_STRUCT  (__rpc_get_spp_desc__ (1))
