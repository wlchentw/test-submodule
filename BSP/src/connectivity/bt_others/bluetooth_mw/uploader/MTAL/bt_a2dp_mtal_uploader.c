...
static INT32 bt_a2dp_mtal_uploader_start(INT32 delay_ms)
{
    ...
    if (MTR_OK == MTAUDDEC_RecordPCM_open())  //uploadid =0, uploadtype=0(unused)
    {

        BT_MTAL_UPL_LOG_NORMAL("MTAUDDEC_RecordPCM_open successfully!\n");
    }
    else
    {
        BT_MTAL_UPL_LOG_ERROR("MTAUDDEC_RecordPCM_open failed!\n");
        return -1 ;
    }
