 ...
 */
 ...
 /*  [operation]
   *      Call to the vendor module to enable btclk and sysclk
   *  [input param]
   *       A pointer to struct containing enbale btclk and sysclk parameter.
   *  [return]
   *      0  - default, dont care.
   *  [callback]
   *      None
   */
    BT_VND_OP_A2DP_ENABLE_BTSYSCLK,

 /*  [operation]
   *      Call to the vendor module to read btclk and sysclk
   *  [input param]
   *       A pointer to uint64 containing btclk and sysclk.
   *  [return]
   *      0  - default, dont care.
   *  [callback]
   *      None
   */
    BT_VND_OP_A2DP_READ_BTSYSCLK,
#endif
} bt_vendor_opcode_t;
