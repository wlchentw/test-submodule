...
#define BPERF_LIBRARY_VERSION "700.0.17121501"
...
static void _bperf_mem_init()
{
    if ( bperf_event_voice == NULL )
        bperf_event_voice = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_rc_fw_upgrade == NULL )
        bperf_event_rc_fw_upgrade = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_hid == NULL )
        bperf_event_hid = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_hid_cursor == NULL )
        bperf_event_hid_cursor = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_hogp == NULL )
        bperf_event_hogp = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_hogp_cursor == NULL )
        bperf_event_hogp_cursor= (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_a2dp == NULL )
        bperf_event_a2dp = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_ble_adv == NULL )
        bperf_event_ble_adv = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);

    if ( bperf_event_voice_analysis == NULL )
        bperf_event_voice_analysis = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_rc_fw_upgrade_analysis == NULL )
        bperf_event_rc_fw_upgrade_analysis = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_hid_analysis == NULL )
        bperf_event_hid_analysis = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_hid_cursor_analysis == NULL )
        bperf_event_hid_cursor_analysis = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_hogp_analysis == NULL )
        bperf_event_hogp_analysis = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_hogp_cursor_analysis == NULL )
        bperf_event_hogp_cursor_analysis = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_a2dp_analysis == NULL )
        bperf_event_a2dp_analysis = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
    if ( bperf_event_ble_adv_analysis == NULL )
        bperf_event_ble_adv_analysis = (struct bperf_event*)malloc(sizeof(struct bperf_event)*MAX_BPERF_EVENTS_IN_A_SECOND);
...
static void _bperf_analysis_rc_fw_upgrade(struct bperf_event *bperf_event)
{
    if ( bperf_event )
    {
        ...
        if ( i > 0 )
        {
            ...
            LOG_INFO(LOG_TAG, LIGHT_BLUE "[bperf](%d) RC FW Upgrade Num(%d), Throughput" GREEN "(%d bps)" NONECOLOR,
    ...
    if ( bperf_event )
    {
        ...
        if ( i > 0 )
        {
            ...
            if (bperf_global_voble_codec == 0)  /* codec : ADPCM */
            {
                ...
                LOG_INFO(LOG_TAG, LIGHT_BLUE "[bperf](%d) VOICE Num(%d), " LIGHT_BLUE ", Voice Data Rate%s(%d bps)%s, Packet Drop%s(%d)%s, Not in time%s(%d)%s, Max Latency%s(%dms)%s",
            ...
            else    /* codec : OPUS */
            {
                ...
                LOG_INFO(LOG_TAG, LIGHT_BLUE "[bperf](%d) VOICE Num(%d), " LIGHT_BLUE ", Voice Data Rate" LIGHT_RED "%s(%d bps)" NONECOLOR,
                                bperf_global_counter,
                                event_counter,
    ...
    if ( bperf_event )
    {
        ...
        if ( i > 0 )
        {
            if ( bperf_event == bperf_event_hid_analysis )
            {
                ...
                LOG_INFO(LOG_TAG, LIGHT_WHITE "[bperf](%d) HID Num(%d) Max_Delta_Time(%dms)" NONECOLOR,
            ...
            else if ( bperf_event == bperf_event_hid_cursor_analysis )
            {
                ...
                LOG_INFO(LOG_TAG, LIGHT_WHITE "[bperf](%d) HID_Cursor Num(%d) Max_Delta_Time(%dms)" NONECOLOR,
                                bperf_global_counter, event_counter, delta_time_max/1000);
            }
            else if ( bperf_event == bperf_event_hogp_analysis )
            {
                ...
                LOG_INFO(LOG_TAG, LIGHT_WHITE "[bperf](%d) HOGP Num(%d) Max_Delta_Time(%dms)" NONECOLOR,
                                bperf_global_counter, event_counter, delta_time_max/1000);
            }
            else if ( bperf_event == bperf_event_hogp_cursor_analysis )
            {
                ...
                LOG_INFO(LOG_TAG, LIGHT_WHITE "[bperf](%d) HOGP_Cursor Num(%d) Max_Delta_Time(%dms)" NONECOLOR,
                                bperf_global_counter, event_counter, delta_time_max/1000);
            }
        }
    }
...
static void _bperf_analysis_a2dp(struct bperf_event *bperf_event)
{
    if ( bperf_event )
    {
        ...
        if ( i > 0 )
        {
            ...
            LOG_INFO(LOG_TAG, LIGHT_PURPLE "[bperf](%d) A2DP Num(%d), %s, %s, %s" NONECOLOR,
...
static void _bperf_analysis_ble_adv(struct bperf_event *bperf_event)
{
    if ( bperf_event )
    {
        ...
        if ( i > 0 )
        {
            ...
            LOG_INFO(LOG_TAG, LIGHT_WHITE "[bperf](%d) BLE ADV Num(%d)" NONECOLOR, bperf_global_counter, event_counter);
        }
    }
}
...
static void _bperf_analysis_inquiry(const uint8_t *buf, const unsigned int buf_len)
{
    ...
    {
        LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_INQUIRY Started (Inquiry_Length:%.2fs)(0ms)" NONECOLOR, (buf[6]*1.28));
              ...
              (buf[0] == 0x07 && buf[1] == 0xff && buf[2] == 0x00) )
    {
        ...
        {
            save_entry = 0;
            LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_EXTEND_INQUIRY_RESULT Entry FULL!! (%d)" NONECOLOR, MAX_BPERF_BT_SCAN_ENTRY);
        }
        ...
        if ( save_entry )
        {
            ...
            if ( buf[0] == 0x2f && buf[1] == 0xff && buf[2] == 0x01 )
            {
                ...
                LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_EXTEND_INQUIRY_RESULT (%d)(%02x:%02x:%02x:%02x:%02x:%02x)(%dms)" NONECOLOR,
            ...
            else if ( buf_len == 13 && buf[0] == 0x19 && buf[1] == 0x04 && buf[2] == 0x0a )
            {
                ...
                LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_REMOTE_NAME_REQUEST (%d)(%02x:%02x:%02x:%02x:%02x:%02x)(%dms)" NONECOLOR,
                            entry_used, buf[8], buf[7], buf[6], buf[5], buf[4], buf[3],
            ...
            else if ( buf[0] == 0x07 && buf[1] == 0xff && buf[2] == 0x00 )
            {
                ...
                LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_REMOTE_NAME_REQUEST_COMPLETE (%d)(%02x:%02x:%02x:%02x:%02x:%02x)(%dms)(%s)" NONECOLOR,
                            entry_used, buf[8], buf[7], buf[6], buf[5], buf[4], buf[3],
    ...
    {
        LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_INQUIRY_COMPLETE (%dms)" NONECOLOR, ((_bperf_get_microseconds()-bt_scan_start_time)/1000));
    }
}
...
static void _bperf_analysis_le_scan(const uint8_t *buf, const unsigned int buf_len)
{
    ...
    if ( buf_len == 5 && buf[0] == 0x0c && buf[1] == 0x20 && buf[2] == 0x02 )
    {
        if ( buf[3] == 1 )
        {
            LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_LE_SCAN_ENABLE Started (Duplicate_Filter:%02x)(0ms)" NONECOLOR, buf[4]);
            ...
            osi_property_set("persist.bt.le_scan_result_count", "");
#else
            ...
            for ( i = 0 ; i < MAX_PROP_BT_SCAN_ENTRY ; i++)
            {
                ...
                //LOG_INFO(LOG_TAG, YELLOW "[bperf] clear property:%s value:%s" NONECOLOR, prop_name_char, "0" );
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                osi_property_set(prop_name_char, "0");
#else
        ...
        else if ( buf[3] == 0 )
        {
            ...
            LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_LE_SCAN_ENABLE Stopped (Duplicate_Filter:%02x)(%dms)" NONECOLOR, buf[4],
                            le_scan_total_time);

            LOG_INFO(LOG_TAG, YELLOW "[bperf] LE Scan Result Count (Total Count:%lu in %dms, Average:%lu/sec)" NONECOLOR, le_scan_result_counter,
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
            osi_property_set("persist.bt.le_scan_result_count", prop_value_char);
#else
    ...
    else if ( buf_len == 10 && buf[0] == 0x0b && buf[1] == 0x20 && buf[2] == 0x07 )
    {
        ...
        LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_LE_SET_SCAN_PARAMETER scan_interval(%.2fms) scan_window(%.2fms)" NONECOLOR, interval, window);
    }
    ...
    else
    {
        ...
        {
            save_entry = 0;
            LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_LE_ADV_REPORT Entry FULL!! (%d)" NONECOLOR, MAX_BPERF_LE_SCAN_ENTRY);
        }
        ...
        if ( save_entry )
        {
            ...
            if ( buf[4] == 0x00 && le_scan_result_time[entry_used][0] == 0x00 )
            {
                ...
                LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_LE_ADV_REPORT (%d)(%02x:%02x:%02x:%02x:%02x:%02x)(%dms)(Connectable_Undirected)" NONECOLOR,
            ...
            else if ( buf[4] == 0x04 && le_scan_result_time[entry_used][1] == 0x00 )
            {
                ...
                LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_LE_ADV_REPORT (%d)(%02x:%02x:%02x:%02x:%02x:%02x)(%dms)(Scan_Response)" NONECOLOR,
                ...
                for ( i = 0 ; i < MAX_PROP_BT_SCAN_ENTRY ; i++)
                {
                    snprintf(prop_name_char, sizeof(prop_name_char), "persist.bt.le_scan_result%02d", i);
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_get(prop_name_char, prop_value_char, "");
#else
                    ...
                    if ( strncmp(prop_value_char, "0", 1) == 0 )
                    {
                        ...
                        LOG_INFO(LOG_TAG, YELLOW "[bperf] LE Scan Result Set Property:%s value:%s " NONECOLOR, prop_name_char, prop_value_char );
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
            ...
            else if ( buf[4] == 0x03 && le_scan_result_time[entry_used][2] == 0x00 )
            {
                ...
                LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_LE_ADV_REPORT (%d)(%02x:%02x:%02x:%02x:%02x:%02x)(%dms)(Non_Connectable_Undirected)" NONECOLOR,
            ...
            {
                LOG_INFO(LOG_TAG, YELLOW "[bperf] HCI_LE_ADV_REPORT (%d)(%02x:%02x:%02x:%02x:%02x:%02x)(%dms)(UNKNOWN 0x%02x)" NONECOLOR,
...
static void _bperf_analysis()
{
    ...
    if (
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
        osi_property_get("persist.bluetooth.bperf.average", prop_value_char, "0")
#else
        property_get("persist.bluetooth.bperf.average", prop_value_char, "0")
#endif
    > 0 )
    {
    ...
    if ( prop_value_int > 0 )
    {
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
        osi_property_set("persist.bluetooth.bperf.average", prop_value_char);
#else
        ...
        if ( prop_value_int == 0 )
        {
            if ( bperf_average_total_time )
            {
                ...
                {
                    LOG_INFO(LOG_TAG, YELLOW "[bperf] BLE ADV Num(average)(%ds) " LIGHT_CYAN "(%d)" NONECOLOR, bperf_average_total_time, (event_counter_summary_ble_adv/bperf_average_total_time));
                    event_counter_summary_ble_adv = 0;
                    snprintf(prop_value_char, 5, "%d", event_counter_summary_ble_adv);
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_set("persist.bt.adv_num", prop_value_char);
#else
                ...
                {
                    LOG_INFO(LOG_TAG, YELLOW "[bperf] A2DP(average)(%ds) Throughput" LIGHT_CYAN "(%d kbps) " YELLOW "Audio Glitch Warning(" LIGHT_CYAN "%d" YELLOW ")" NONECOLOR,
                ...
                {
                    LOG_INFO(LOG_TAG, YELLOW "[bperf] HID(average)(%ds) Num" LIGHT_CYAN "(%d)" YELLOW " Max_Delta_Time(%dms)" NONECOLOR,
                            bperf_average_total_time,
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_set("persist.bt.hid_num", prop_value_char);
#else
                ...
                {
                    LOG_INFO(LOG_TAG, YELLOW "[bperf] HID_Cursor(average)(%ds) Num" LIGHT_CYAN "(%d)" YELLOW " Max_Delta_Time(%dms)" NONECOLOR,
                            bperf_average_total_time,
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_set("persist.bt.hid_cur_num", prop_value_char);
#else
                ...
                {
                    LOG_INFO(LOG_TAG, YELLOW "[bperf] HOGP(average)(%ds) Num" LIGHT_CYAN "(%d)" YELLOW " Max_Delta_Time(%dms)" NONECOLOR,
                            bperf_average_total_time,
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_set("persist.bt.hopg_num", prop_value_char);
#else
                ...
                {
                    LOG_INFO(LOG_TAG, YELLOW "[bperf] HOGP_Cursor(average)(%ds) Num" LIGHT_CYAN "(%d)" YELLOW " Max_Delta_Time(%dms)" NONECOLOR,
                            bperf_average_total_time,
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_set("persist.bt.hopg_cur_num", prop_value_char);
#else
                ...
                {
                    LOG_INFO(LOG_TAG, YELLOW "[bperf] VOICE(average)(%ds) Voice Data Rate" LIGHT_CYAN "(%d bps)" YELLOW " Total Packet Drop" LIGHT_CYAN "(%d)" NONECOLOR,
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_set("persist.bt.voble_avg_rate", prop_value_char);
#else
                    property_set("persist.bt.voble_avg_rate", prop_value_char);
#endif
                    snprintf(prop_value_char, 8, "%d", event_len_summary_voice_drop);
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_set("persist.bt.voble_avg_drop", prop_value_char);
#else
                ...
                {
                    LOG_INFO(LOG_TAG, YELLOW "[bperf] VOICE(average)(%ds) Voice Data Rate" LIGHT_CYAN "(%d bps)" NONECOLOR, bperf_average_total_time, (event_len_summary_rc_fw_upgrade<<3)/bperf_average_total_time);
                    snprintf(prop_value_char, 5, "%d", (event_len_summary_rc_fw_upgrade<<3)/bperf_average_total_time);
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
                    osi_property_set("persist.bt.rc_fw_upg_avg_rate", prop_value_char);
#else
...
static void *_bperf_thread_main(void *arg)
{
    ...
    (void)arg;
    LOG_INFO(LOG_TAG, "Thread Started");
    ...
    {
        LOG_ERROR(LOG_TAG, "Allocate memory failed!");
        LOG_INFO(LOG_TAG, "Thread Stopped");
        return 0;
    }
...
static void _bperf_thread_start()
{
    ...
    {
        LOG_INFO(LOG_TAG, "Create thread");
...
static void _bperf_thread_stop()
{
    ...
    pthread_join(bperf_thread_main, NULL);
}

void bperf_notify_cmd(const uint8_t *buf, const unsigned int buf_len)
{
    if ( bperf_inited && bperf_main_thread_status == BPERF_STATE_THREAD_RUNNING && !bperf_main_thread_should_stop )
    {
        /* HCI_LE_SCAN_ENABLE */
        if ( buf_len == 5 && buf[0] == 0x0c && buf[1] == 0x20 && buf[2] == 0x02 )
        {
...
void bperf_notify_data(const uint8_t *buf, const unsigned int buf_len)
{
    if ( bperf_inited && bperf_main_thread_status == BPERF_STATE_THREAD_RUNNING && !bperf_main_thread_should_stop )
    {
        ...
        /* A2DP Src , Buf Len = 587, SCMS-T Enabled */
        else if ( buf_len == 587 && buf[8] == 0x80 && buf[9] == 0x60 && buf[20] == 0x00 )
        {
            _bperf_mem_record_event(bperf_event_a2dp, buf, buf_len);
            bperf_global_bitpool = buf[24];
        }
        /* A2DP Src , Buf Len = 616, SCMS-T Disabled */
        else if ( buf_len == 616 && buf[8] == 0x80 && buf[9] == 0x60 && buf[20] != 0x00)
        {
            _bperf_mem_record_event(bperf_event_a2dp, buf, buf_len);
            bperf_global_bitpool = buf[23];
        }
...
void bperf_init()
{
    ...
    if (
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
    osi_property_get("bt.bperf.enable", prop_value_char, "")
#else
    property_get("bt.bperf.enable", prop_value_char, "")
#endif
    &&
        strncmp(prop_value_char, "1", 1) == 0)
    {
        LOG_INFO(LOG_TAG, YELLOW "[bperf] bperf_init() Version : %s" NONECOLOR, BPERF_LIBRARY_VERSION);
...
void bperf_deinit()
{
    if (bperf_inited)
    {
        LOG_INFO(LOG_TAG, YELLOW "[bperf] bperf_deinit() Version : %s" NONECOLOR, BPERF_LIBRARY_VERSION);
        _bperf_thread_stop();
        _bperf_mem_free();
