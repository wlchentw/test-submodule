...
static const interop_addr_entry_t interop_addr_database[] = {
  ...
  {{{0xb0, 0xe1, 0x7e,       0,0,0}}, 3, INTEROP_MTK_HID_NOT_SET_SLAVE},
...
static const interop_name_entry_t interop_name_database[] = {
  ...
  // Flush l2cap buffer and part of a2dp buffer to avoid silent of AirPods.
  {"AirPods", 7, INTEROP_MTK_FLUSH_L2C_A2D_BUF},
#endif
  ...
  {"CAR",     3, INTEROP_DISABLE_AUTO_PAIRING},
  {"xs-soundbar",     11, INTEROP_DISABLE_AUTO_PAIRING},
};
