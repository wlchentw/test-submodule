...
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
#define AVDT_NUM_SEPS               (3 +  MTK_A2DP_SRC_APTX_SEP + MTK_A2DP_SRC_AAC_SEP + MTK_A2DP_SINK_AAC_SEP + MTK_A2DP_SRC_STE_SEP + MTK_A2DP_SINK_STE_SEP)
#else
#define AVDT_NUM_SEPS               (3 +  MTK_A2DP_SRC_APTX_SEP + MTK_A2DP_SRC_AAC_SEP + MTK_A2DP_SINK_AAC_SEP + MTK_A2DP_SRC_STE_SEP + MTK_A2DP_SINK_STE_SEP)
#endif
#else
...
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
#define AVCT_NUM_LINKS              4 // currently support three avdtp links
#else
...
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
#define AVCT_NUM_CONN               5 // currently support three avdtp links
#else
