...
const char *BTSNOOP_MAX_FILE_NUM_KEY = "BtSnoopMaxFileNum";
#endif
...
static int get_btsnoop_max_file_num(void) {
  return config_get_int(config, CONFIG_DEFAULT_SECTION, BTSNOOP_MAX_FILE_NUM_KEY, 0);
}
