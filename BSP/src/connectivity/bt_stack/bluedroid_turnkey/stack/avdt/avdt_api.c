...
void AVDT_SINK_Activate()
{
    ...
    tAVDT_SCB           *p_scb = &avdt_cb.ccb[0].scb[0];
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
UINT16 AVDT_CreateStream(UINT8 *p_handle, tAVDT_CS *p_cs, UINT8 peer_id)
{
    ...
    else if ((p_scb = avdt_scb_alloc(p_cs, peer_id)) == NULL)
    {
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
UINT16 AVDT_DiscoverReq(BD_ADDR bd_addr, UINT8 peer_id, tAVDT_SEP_INFO *p_sep_info,
...
#endif
{
    ...
    {
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
        if ((p_ccb = avdt_ccb_alloc_by_peer_id(bd_addr, peer_id)) == NULL)
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
static UINT16 avdt_get_cap_req(BD_ADDR bd_addr, UINT8 peer_id, tAVDT_CCB_API_GETCAP *p_evt)
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
UINT16 AVDT_GetCapReq(BD_ADDR bd_addr, UINT8 peer_id, UINT8 seid, tAVDT_CFG *p_cfg, tAVDT_CTRL_CBACK *p_cback)
#else
...
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
    return avdt_get_cap_req (bd_addr, peer_id, &getcap);
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
UINT16 AVDT_GetAllCapReq(BD_ADDR bd_addr, UINT8 peer_id, UINT8 seid, tAVDT_CFG *p_cfg, tAVDT_CTRL_CBACK *p_cback)
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
UINT16 AVDT_OpenReq(UINT8 handle, BD_ADDR bd_addr, UINT8 peer_id, UINT8 seid, tAVDT_CFG *p_cfg)
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
UINT16 AVDT_ConnectReq(BD_ADDR bd_addr, UINT8 peer_id, UINT8 sec_mask, tAVDT_CTRL_CBACK *p_cback)
#else
