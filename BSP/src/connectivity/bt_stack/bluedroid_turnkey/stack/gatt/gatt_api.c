...
EXPORT_SYMBOL UINT16 GATTS_CreateService (tGATT_IF gatt_if, tBT_UUID *p_svc_uuid,
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL UINT16 GATTS_AddCharacteristic (UINT16 service_handle, tBT_UUID *p_char_uuid,
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL UINT16 GATTS_AddCharDescriptor (UINT16 service_handle,
                                 tGATT_PERM perm,
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL tGATT_STATUS GATTS_StartService (tGATT_IF gatt_if, UINT16 service_handle,
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL tGATT_STATUS GATTS_HandleValueNotification (UINT16 conn_id, UINT16 attr_handle,
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL tGATT_STATUS GATTS_SendRsp (UINT16 conn_id,  UINT32 trans_id,
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL tGATT_STATUS GATTC_ConfigureMTU (UINT16 conn_id, UINT16 mtu)
#else
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL tGATT_STATUS GATTC_Discover (UINT16 conn_id, tGATT_DISC_TYPE disc_type,
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL tGATT_STATUS GATTC_Write (UINT16 conn_id, tGATT_WRITE_TYPE type, tGATT_VALUE *p_write)
#else
...
**                  p_cb_info: callback functions.
                    gattx_flag:  flag for gattc or gatts, gattc:1,gatts:2,NULL:0
**
** Returns          0 for error, otherwise the index of the client registered with GATT
**
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
#if defined(MTK_GATT_CLIENT_AND_SERVER) && (MTK_GATT_CLIENT_AND_SERVER == TRUE)
EXPORT_SYMBOL tGATT_IF GATT_Register (tBT_UUID *p_app_uuid128, tGATT_CBACK *p_cb_info, UINT8 gattx_flag)
#else
EXPORT_SYMBOL tGATT_IF GATT_Register (tBT_UUID *p_app_uuid128, tGATT_CBACK *p_cb_info)
#endif
#else
#if defined(MTK_GATT_CLIENT_AND_SERVER) && (MTK_GATT_CLIENT_AND_SERVER == TRUE)
tGATT_IF GATT_Register (tBT_UUID *p_app_uuid128, tGATT_CBACK *p_cb_info, UINT8 gattx_flag)
#else
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL BOOLEAN GATT_Connect (tGATT_IF gatt_if, BD_ADDR bd_addr, BOOLEAN is_direct,
...
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL void GATTC_MeshSetConnStatus(BD_ADDR bd_addr, UINT16 handle)
{
    gatt_mesh_set_conn_status(bd_addr, handle);
}
#endif
...
*******************************************************************************/
#if defined(MTK_MESH_SUPPORT) && defined(MTK_GATT_BEARER_SUPPORT)
EXPORT_SYMBOL tGATT_STATUS GATT_Disconnect (UINT16 conn_id)
#else
