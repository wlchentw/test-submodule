...
#define AVRC_MSG_BROWSE_OFFSET      20
...
extern void avrc_start_cmd_timer(uint8_t handle, uint8_t label, uint8_t msg_mask);
extern void avrc_send_next_vendor_cmd(uint8_t handle);
#endif
