...
// set_bt_a2dp_acl_priority begin
    ...
    UINT8               tci_acl_priority;      /* L2C_PRIORITY_NORMAL or L2C_PRIORITY_HIGH */
    BOOLEAN             is_acl_type_a2dp_sink; /* Flag to track if Channel is for A2DP Sink .*/
#endif
// set_bt_a2dp_acl_priority end
    ...
    UINT8 mesh_gatt_link_conn_status;
#endif
} tL2C_LCB;
...
#ifdef MTK_A2DP_SET_ACL_PRIORITY
extern BOOLEAN  l2cu_set_acl_priority_by_tci (BD_ADDR bd_addr, UINT8 priority);
#endif
