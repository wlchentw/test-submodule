...
#define BTM_BLE_EXT_ADV_DATA_LEN    251
#endif
...
#define BTM_BLE_GAP_DISC_SCAN_INT      144        /* Interval(scan_int) = 90 ms= 0x0090 * 0.625 ms */
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
#define BTM_BLE_ADV_DATA_LEN_MAX        251
#define BTM_BLE_CACHE_ADV_DATA_MAX      502
#else
...
typedef struct
{
    ...
    UINT32 mesh_scan_window;   /* for mesh sacn */
    UINT32 mesh_scan_interval; /* for mesh sacn */
    UINT8 mesh_scan_type;      /* current scan type: active or passive */
#endif
} tBTM_BLE_INQ_CB;
...
typedef void (*bt_hci_evt_callback_func_t) (const UINT8 *data, UINT8 size);
#endif
...
#ifdef MTK_MESH_SUPPORT
    /* mesh callback and flag */
    tBTM_INQ_RESULTS_CB *p_mesh_results_cb;
    BOOLEAN mesh_enabled;
#ifdef MTK_GATT_BEARER_SUPPORT
    bt_hci_evt_callback_func_t hci_evt_cb;
#endif
#endif
...
extern void btm_ble_process_phy_update_pkt(UINT8 len, UINT8* data);
#endif
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
extern void btm_ext_gen_resolvable_private_addr (void *p_cmd_cplt_cback);
#endif
