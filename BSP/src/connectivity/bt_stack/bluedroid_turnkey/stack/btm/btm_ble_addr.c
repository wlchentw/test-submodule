...
/*******************************************************************************
**
** Function         btm_ext_gen_resolvable_private_addr
**
** Description      This function generate a resolvable private address.
**
** Returns          void
**
*******************************************************************************/
void btm_ext_gen_resolvable_private_addr (void *p_cmd_cplt_cback)
{
    BTM_TRACE_EVENT ("btm_ext_gen_resolvable_private_addr");
    /* generate 3B rand as BD LSB, SRK with it, get BD MSB */
    btsnd_hcic_ext_ble_rand(p_cmd_cplt_cback);
}
#endif
...
static BOOLEAN btm_ble_match_random_bda(void *data, void *context)
{
    ...
    BTM_TRACE_VERBOSE("%s next iteration", __func__);
...
void btm_ble_resolve_random_addr(BD_ADDR random_bda, tBTM_BLE_RESOLVE_CBACK * p_cback, void *p)
{
    ...
    if ( !p_mgnt_cb->busy) {
        ...
        BTM_TRACE_VERBOSE("%s:  %sresolved", __func__, (p_dev_rec == NULL ? "not " : ""));
...
tBTM_SEC_DEV_REC* btm_find_dev_by_identity_addr(BD_ADDR bd_addr, UINT8 addr_type)
{
    ...
    if (!btm_cb.sec_dev_rec || list_is_empty(btm_cb.sec_dev_rec)) {
        return NULL;
    }
