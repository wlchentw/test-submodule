...
BT_OCTET16 ble_encryption_key_value; /* BLE encryption key */
    ...
    tBTM_CMPL_CB        *p_vendor_rssi_cmpl_cb;     /* Callback function to be called when  */
                                                    /* read RSSI raw data function completes */
    tBTM_CMPL_CB        *p_vendor_per_cmpl_cb;      /* Callback function to be called when  */
                                                    /* read per function completes */
#endif
} tBTM_DEVCB;
...
typedef struct
{
    ...
    **      Security Management
    *****************************************************/
    tBTM_APPL_INFO          api; /* bta_security */

#define BTM_SEC_MAX_RMT_NAME_CALLBACKS  3
    ...
    UINT8 extended_adv_support;
    UINT8 periodic_adv_support;
    UINT8 adv_set_max;            /* max adv set supported in controller */
#endif
} tBTM_CB;
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
extern void btm_extended_cmd_complete(UINT8 *p, UINT16 opcode, UINT16 evt_len,
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
extern void btm_advertising_terminated_evt(UINT8 *p, UINT8 evt_len);
#endif
...
#if defined(MTK_BT_PERFORMANCE_ANALYSIS) && (MTK_BT_PERFORMANCE_ANALYSIS == TRUE)
extern void         btm_read_vendor_per_complete(uint8_t *p);
extern void         btm_read_vendor_rssi_complete(uint8_t *p);
#endif
