...
#define A2D_AAC_BAD_OBJECT_TYPE     0xF1  /* Object type is not valid  */
#define A2D_AAC_BAD_SAMP_FREQ       0xF2  /* Sampling Frequency is not valid or multiple values have been selected  */
#define A2D_AAC_BAD_CH_MODE         0xF3  /* Channel Mode is not valid or multiple values have been selected  */
#define A2D_AAC_BAD_PARAMETER       0xFF
#endif
