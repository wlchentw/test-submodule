...
typedef void (tGATT_PHY_UPDATE_CB)(tGATT_IF gatt_if, BD_ADDR bd_addr,
                                UINT8 tx_phy, UINT8 rx_phy, UINT8 status);
#endif
...
/* flag for gattc or gatts, gattc:1,gatts:2,NULL:0 */
#define GATT_NULL_FLAG      0
#define GATT_CLINET_FLAG    0x1
#define GATT_SERVER_FLAG    0X2
#endif
...
*******************************************************************************/
#if defined(MTK_GATT_CLIENT_AND_SERVER) && (MTK_GATT_CLIENT_AND_SERVER == TRUE)
extern  tGATT_IF GATT_Register (tBT_UUID *p_app_uuid128, tGATT_CBACK *p_cb_info, UINT8 gattx_flag);
#else
