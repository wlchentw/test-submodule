...
/*Extended and Periodic Adv Commands, Porting from Android P*/
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
/* extended multi adv feature */
#define BTM_BLE_EXT_MULTI_ADV_SET_RANDOM_ADDR               0x06
#define BTM_BLE_EXT_MULTI_ADV_SET_PARAM                     0x07
#define BTM_BLE_EXT_MULTI_ADV_WRITE_ADV_DATA                0x08
#define BTM_BLE_EXT_MULTI_ADV_WRITE_SCAN_RSP_DATA           0x09
#define BTM_BLE_EXT_MULTI_ADV_ENB                           0x0A
/* periodic multi adv feature */
#define BTM_BLE_PERIODIC_MULTI_ADV_SET_PARAM                0x0B
#define BTM_BLE_PERIODIC_MULTI_ADV_WRITE_ADV_DATA           0x0C
#define BTM_BLE_PERIODIC_MULTI_ADV_ENB                      0x0D
#define BTM_BLE_REMOVE_ADVERTISING_SET                      0x0E
#endif
...
/* Parameter info for MTK_A2DP_SET_ACL_PRIORITY
 * Used to set the ACL priority for A2DP Sink and Source.
 */
#define HCI_A2DP_ACL_PRIORITY_PARAM_SIZE   4
#define HCI_A2DP_ACL_PRIORITY_LOW          0x0
#define HCI_A2DP_ACL_PRIORITY_HIGH         0x1
#define HCI_A2DP_ACL_PRIORITY_TYPE_SRC     0x0
#define HCI_A2DP_ACL_PRIORITY_TYPE_SNK     0x1
#endif
...
#define HCI_EXT_FEATURES_PAGE_MAX   (HCI_EXT_FEATURES_PAGE_2 + 3)
#else
...
#define HCI_LE_FEATURE_2M_PHY_ON               1
#define HCI_LE_2M_PHY_SUPPORTED(x) ((x)[HCI_LE_FEATURE_2M_PHY_ON] & HCI_LE_FEATURE_2M_PHY_MASK)

#define HCI_LE_FEATURE_CODED_PHY_MASK          0x08
#define HCI_LE_FEATURE_CODED_PHY_ON            1
#define HCI_LE_CODED_PHY_SUPPORTED(x) ((x)[HCI_LE_FEATURE_CODED_PHY_ON] & HCI_LE_FEATURE_CODED_PHY_MASK)

#define HCI_LE_FEATURE_EXTENDED_ADVERTISING_MASK          0x10
#define HCI_LE_FEATURE_EXTENDED_ADVERTISING_ON            1
#define HCI_LE_EXTENDED_ADVERTISING_SUPPORTED(x) ((x)[HCI_LE_FEATURE_EXTENDED_ADVERTISING_ON] & HCI_LE_FEATURE_EXTENDED_ADVERTISING_MASK)

#define HCI_LE_FEATURE_PERIODIC_ADVERTISING_MASK          0x20
#define HCI_LE_FEATURE_PERIODIC_ADVERTISING_ON            1
#define HCI_LE_PERIODIC_ADVERTISING_SUPPORTED(x) ((x)[HCI_LE_FEATURE_PERIODIC_ADVERTISING_ON] & HCI_LE_FEATURE_PERIODIC_ADVERTISING_MASK)
#endif
...
#define HCI_VENDOR_READ_PER     0xFD11
#define HCI_VENDOR_READ_RSSI    0xFC61
#endif

/* support LE set privacy mode */
