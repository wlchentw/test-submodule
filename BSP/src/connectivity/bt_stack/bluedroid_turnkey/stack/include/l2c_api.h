...
**
*******************************************************************************/
extern BOOLEAN L2CA_SetAclPriority_By_Tci (BD_ADDR bd_addr, UINT8 priority);
...
**
*******************************************************************************/
extern BOOLEAN L2CA_SetAclLinkType(BD_ADDR bd_addr, BOOLEAN is_a2dp_sink);
#endif
...
extern void L2CA_MeshSetConnStatus(BD_ADDR bd_addr, UINT16 handle);
#endif
...
extern BOOLEAN L2CA_EnableUpdateBleConnParamsOnly (BD_ADDR rem_bda, BOOLEAN enable);
