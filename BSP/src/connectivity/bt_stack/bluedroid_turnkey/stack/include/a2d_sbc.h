...
extern tA2D_STATUS A2D_BldSteInfo(UINT8 media_type, tA2D_SBC_CIE *p_ie,
                                  UINT8 *p_result);
#endif
/******************************************************************************
**
...
extern tA2D_STATUS A2D_ParsSbcInfo(tA2D_SBC_CIE *p_ie, const UINT8 *p_info,
                                   BOOLEAN for_caps);
//#if defined(MTK_A2DP_SRC_STE_CODEC) && (MTK_A2DP_SRC_STE_CODEC == TRUE) || defined(MTK_A2DP_SNK_STE_CODEC) && (MTK_A2DP_SNK_STE_CODEC == TRUE)
extern tA2D_STATUS A2D_ParsSteInfo(tA2D_SBC_CIE *p_ie, const UINT8 *p_info,
                                   BOOLEAN for_caps);
//#endif
...
extern int A2D_GetSinkFramesCountToProcessSbc(uint64_t time_interval_ms,
