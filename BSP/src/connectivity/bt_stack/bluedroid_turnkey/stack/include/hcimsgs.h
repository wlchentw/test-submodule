...
extern void btsnd_hcic_ext_ble_rand (void *p_cmd_cplt_cback);
extern void btsnd_hcic_ble_set_extended_scan_enable(UINT8 enable,
                                                    UINT8 filter_duplicates,
                                                    UINT16 duration,
                                                    UINT16 period);
extern void btsnd_hcic_ble_set_extended_scan_params(UINT8 own_address_type, UINT8 scanning_filter_policy,
                                                    UINT8 scanning_phys, tSCANNING_PHY_CFG* phy_cfg);
...
extern BOOLEAN btsnd_hcic_ble_ext_create_conn(UINT8 init_filter_policy,
                                           UINT8 addr_type_own,
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
extern BOOLEAN btsnd_hcic_ble_read_phy (UINT16 handle);

extern BOOLEAN btsnd_hcic_ble_set_default_phy (UINT8 all_phys, UINT8 tx_phys, UINT8 rx_phys);

extern BOOLEAN btsnd_hcic_ble_set_phy (UINT16 handle, UINT8 all_phys, UINT8 tx_phys, UINT8 rx_phys, UINT16 phy_options);
#endif
...
extern bool btsnd_hcic_read_vendor_rssi(uint16_t handle);           /* Read Vendor RSSI */
extern bool btsnd_hcic_read_vendor_per(void);                       /* Read Vendor PER */
#endif
#endif
