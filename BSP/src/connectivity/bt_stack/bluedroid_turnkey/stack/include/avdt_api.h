...
#define AVDT_VENDOR_CODEC_VENDOR_ID_IDX 3
#define AVDT_VENDOR_CODEC_CODEC_ID_IDX 7
...
typedef struct {
    ...
    UINT8       idle_tout;  /* AVDTP idle signaling channel timeout BTA_AV_IDLE_TOUT */
...
typedef UINT16 (tAVDT_GETCAP_REQ) (BD_ADDR bd_addr, UINT8 peer_id, UINT8 seid, tAVDT_CFG *p_cfg, tAVDT_CTRL_CBACK *p_cback);
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
extern UINT16 AVDT_CreateStream(UINT8 *p_handle, tAVDT_CS *p_cs, UINT8 peer_id);
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
extern UINT16 AVDT_GetCapReq(BD_ADDR bd_addr, UINT8 peer_id, UINT8 seid,
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
extern UINT16 AVDT_GetAllCapReq(BD_ADDR bd_addr, UINT8 peer_id, UINT8 seid,
    tAVDT_CFG *p_cfg, tAVDT_CTRL_CBACK *p_cback);
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
extern UINT16 AVDT_OpenReq(UINT8 handle, BD_ADDR bd_addr, UINT8 peer_id,
    UINT8 seid, tAVDT_CFG *p_cfg);
#else
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
extern UINT16 AVDT_ConnectReq(BD_ADDR bd_addr, UINT8 peer_id, UINT8 sec_mask,
                              tAVDT_CTRL_CBACK *p_cback);
#else
