                                    ...
                                    UINT8 *p_req_end)
{
    ...
    {
        p_rec = sdp_db_service_search (p_rec, &uid_seq, TRUE);
                                             ...
                                             UINT8 *p_req_end)
{
    ...
    /* Get a list of handles that match the UUIDs given to us */
    for (p_rec = sdp_db_service_search (p_ccb->cont_info.prev_sdp_rec, &uid_seq, FALSE); p_rec; p_rec = sdp_db_service_search (p_rec, &uid_seq, FALSE))
    {
