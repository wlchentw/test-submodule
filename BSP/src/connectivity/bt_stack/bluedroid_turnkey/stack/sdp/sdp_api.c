                                  ...
                                  tSDP_DISC_CMPL_CB *p_cb)
{
    ...
    tCONN_CB     *p_ccb;
      ...
      if (sdp_connection_pending_request_queue(SDP_SS_REQUEST, p_bd_addr, p_db, p_cb, NULL, NULL))
      {
          SDP_TRACE_DEBUG("SDP_ServiceSearchRequest pending this request");
          return(TRUE);
      }
#endif
...
#if defined(MTK_LINUX) && defined(MTK_COMMON) && (MTK_COMMON == TRUE)
      if (sdp_connection_pending_request_queue(SDP_SSA_REQUEST, p_bd_addr, p_db, p_cb, NULL, NULL))
      {
          SDP_TRACE_DEBUG("SDP_ServiceSearchAttributeRequest pending this request");
          return(TRUE);
      }
#endif
...
#if defined(MTK_LINUX) && defined(MTK_COMMON) && (MTK_COMMON == TRUE)
      if (sdp_connection_pending_request_queue(SDP_SSA_REQUEST2, p_bd_addr, p_db, NULL, p_cb2, user_data))
      {
          SDP_TRACE_DEBUG("SDP_ServiceSearchAttributeRequest2 pending this request");
          return(TRUE);
      }
#endif
