...
int osi_socket_make_sockaddr_un(const char *name, int namespaceId,
  ...
  switch (namespaceId) {
    ...
    case ANDROID_SOCKET_NAMESPACE_RESERVED:
      ...
      strncpy(p_addr->sun_path, ANDROID_RESERVED_SOCKET_PREFIX, sizeof(p_addr->sun_path));
      p_addr->sun_path[sizeof(p_addr->sun_path) - 1] = '\0';
      if (sizeof(p_addr->sun_path) > strlen(p_addr->sun_path) + 1)
      {
    ...
    case ANDROID_SOCKET_NAMESPACE_FILESYSTEM:
      ...
      strncpy(p_addr->sun_path, name, sizeof(p_addr->sun_path));
      p_addr->sun_path[sizeof(p_addr->sun_path) - 1] = '\0';
      break;
    default:
