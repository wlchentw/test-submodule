...
EXPORT_SYMBOL hash_map_t *hash_map_new(
#else
...
#if defined(MTK_LINUX) && defined(MTK_COMMON) && (MTK_COMMON == TRUE)
EXPORT_SYMBOL void hash_map_free(hash_map_t *hash_map) {
#else
...
#if defined(MTK_LINUX) && defined(MTK_COMMON) && (MTK_COMMON == TRUE)
EXPORT_SYMBOL bool hash_map_set_duplicate(hash_map_t *hash_map, const void *key, void *data) {
  assert(hash_map != NULL);
  assert(data != NULL);
  ...
  hash_map_entry_t *hash_map_entry = hash_map->allocator->alloc(sizeof(hash_map_entry_t));
...
#if defined(MTK_LINUX) && defined(MTK_COMMON) && (MTK_COMMON == TRUE)
EXPORT_SYMBOL void *hash_map_get(const hash_map_t *hash_map, const void *key) {
#else
...
#if defined(MTK_LINUX) && defined(MTK_COMMON) && (MTK_COMMON == TRUE)
EXPORT_SYMBOL void hash_map_foreach(hash_map_t *hash_map, hash_map_iter_cb callback, void *context) {
#else
