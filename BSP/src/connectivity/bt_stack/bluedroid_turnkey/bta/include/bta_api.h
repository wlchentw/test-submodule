...
typedef struct
{
    ...
    UINT8                   secondary_advertising_phy;
    UINT8                   scan_request_notification_enable;
}tBTA_BLE_ADVERTISING_PARAMS;

#define MAX_BTA_SIZE_ADV_DATA_LEN 1024
typedef struct
{
    UINT32 adv_len;
    UINT8 adv_data[MAX_BTA_SIZE_ADV_DATA_LEN];
}tBTA_BLE_PERI_ADV_DATA;
...
}tBTA_BLE_PERIODIC_ADV_PARAMS;

typedef struct
{
    tBTA_BLE_ADVERTISING_PARAMS     adv_params;
    tBTA_BLE_PERI_ADV_DATA          adv_data;
    tBTA_BLE_PERI_ADV_DATA          adv_scan_rsp_data;
    tBTA_BLE_PERIODIC_ADV_PARAMS    peri_params;
    tBTA_BLE_PERI_ADV_DATA          peri_adv_data;
    UINT16                          duration;
    UINT8                           maxExtAdvEvents;
}tBTA_BLE_ADVERTISING_SET;

#define BTA_BLE_ADV_DATA_TYPE           0
#define BTA_BLE_ADV_DATA_SCAN_RSP_TYPE  1
#define BTA_BLE_ADV_DATA_PERIODIC_TYPE  2
typedef UINT8 tBTA_BLE_ADV_TYPE;
#endif
...
#if defined(MTK_COMMON) && (MTK_COMMON == TRUE)
/* M: add structure associated with BTA_DM_REM_NAME_EVT */
typedef struct
{
  BD_ADDR bd_addr; /* BD address peer device. */
  BD_NAME bd_name; /* Name of peer device. */
...
#define BTA_BLE_EXT_ADV_DATA_EVT            7
#define BTA_BLE_ADV_SET_PERI_PARAM_EVT      8
#define BTA_BLE_ADV_SET_PERI_DATA_EVT       9
#define BTA_BLE_ADV_PERI_ENABLE_EVT         10
#define BTA_BLE_ADV_PERI_DISABLE_EVT        11
#define BTA_BLE_REMOVE_ADVERTISING_SET_EVT  12

/* not match btm bellow*/
#define BTA_BLE_ADV_START_ADVERTISING_SET_EVT        20
#define BTA_BLE_ADV_STOP_ADVERTISING_SET_EVT         21
#endif
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
extern void BTA_BleSetExtAdvData (UINT32 client_if, BOOLEAN is_scan_rsp,
                            tBTA_BLE_AD_MASK data_mask,
                            tBTA_BLE_ADV_DATA *p_data);

extern void BTA_BleStartAdvertisingSet (
                        tBTA_BLE_ADVERTISING_SET *p_start_advertising_set,
                                  tBTA_BLE_MULTI_ADV_CBACK *p_cback,
                                  void *p_ref);

extern void BTA_BleStopAdvertisingSet(UINT8 inst_id);

extern void BTA_BleAdvSetPeriodicParam (UINT8 inst_id,
                        tBTA_BLE_PERIODIC_ADV_PARAMS *p_peri_param,
                        tBTA_BLE_MULTI_ADV_CBACK *p_cback,
                                  void *p_ref);

extern void BTA_BleAdvPeriodicEnable (UINT8 inst_id, UINT8 enable,
                             tBTA_BLE_MULTI_ADV_CBACK *p_cback,
                                                   void *p_ref);

extern void BTA_BleAdvSetAdvertisingData (UINT8 inst_id, UINT8 adv_data_type,
                                  tBTA_BLE_PERI_ADV_DATA *p_advertising_data,
                                  tBTA_BLE_MULTI_ADV_CBACK *p_cback,
                                  void *p_ref);

extern void BTA_BleAdvertisingSetParam (UINT8 inst_id,
                            tBTA_BLE_ADVERTISING_PARAMS *p_params);
#endif
/*******************************************************************************
**
