...
/* maximum number of streams created: 2 for audio, 1 for video */
#define BTA_AV_NUM_STRS         3
#define BTA_AV_NUM_CONNS        (BTA_AV_NUM_STRS - 1)
#else
...
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
#define BTA_AV_MAX_SEPS         BTA_AV_NUM_CONNS*(2 + MTK_A2DP_SRC_APTX_SEP + MTK_A2DP_SRC_AAC_SEP + MTK_A2DP_SINK_AAC_SEP + MTK_A2DP_SRC_STE_SEP + MTK_A2DP_SINK_STE_SEP)
#else
#define BTA_AV_MAX_SEPS         (2 + MTK_A2DP_SRC_APTX_SEP + MTK_A2DP_SRC_AAC_SEP + MTK_A2DP_SINK_AAC_SEP + MTK_A2DP_SRC_STE_SEP + MTK_A2DP_SINK_STE_SEP)
#endif
#else
...
// MTK_A2DP_SILENT_STREAM_PRIORITY begin
#ifdef MTK_A2DP_SILENT_STREAM_PRIORITY
/* ACL priority parameters */
#define BTA_AV_ACL_PRIORITY_NORMAL      L2CAP_PRIORITY_NORMAL
#define BTA_AV_ACL_PRIORITY_HIGH        L2CAP_PRIORITY_HIGH
#endif
// MTK_A2DP_SILENT_STREAM_PRIORITY end
...
#define BTA_AV_CODEC_STE        A2D_MEDIA_CT_STE        /* Stereo media codec type */

#define BTA_AV_CODEC_NON        A2D_MEDIA_CT_NON
...
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
#define BTA_AV_ACTIVE_SRC       25
#define BTA_AV_ACTIVE_SINK      26
...
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
typedef void (tBTA_AV_DATA_CBACK)(tBTA_AV_EVT event, tBTA_AV_MEDIA *p_data, BD_ADDR *bd_addr);
#else
...
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
void BTA_AvActiveSrc(bt_bdaddr_t *bdaddr);

void BTA_AvActiveSink(bt_bdaddr_t *bdaddr);

/*******************************************************************************
**
** Function         BTA_AvStreamDataCheck
**
** Description      Enable the mute stream data check to switch active device
**                     when stream data change from mute to unmute in the pause_timer.
** Returns          void
**
*******************************************************************************/
void BTA_AvStreamDataCheck(bt_bdaddr_t *bdaddr, BOOLEAN start);
#endif
...
*******************************************************************************/
#if defined(MTK_A2DP_DUAL_AUDIO) && (MTK_A2DP_DUAL_AUDIO == TRUE)
void BTA_AvStop(tBTA_AV_HNDL handle, BOOLEAN suspend);
#else
...
/*******************************************************************************
**
** Function         BTA_AvSetAclPriority
**
** Description      Change the ACL priority for A2DP to BTA_AV_ACL_PRIORITY_NORMAL or
**                              BTA_AV_ACL_PRIORITY_HIGH.
**
** Returns          void
**
*******************************************************************************/
void BTA_AvSetAclPriority(tBTA_AV_HNDL hndl, UINT8 priority);
#endif
// MTK_A2DP_SILENT_STREAM_PRIORITY end
...
void BTA_AvCodecEnable(UINT8 codec_type, UINT8 enable);
#endif
