...
#endif
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
#define BTA_GATTC_PHY_UPDATE_EVT   36       /* update phy event*/
#define BTA_GATTC_PERI_ADV_ENB_EVT  37      /* Enable PERIODIC ADV event */
#define BTA_GATTC_PERI_ADV_DISABLE_EVT  38  /* Disable PERIODIC ADV event */
#define BTA_GATTC_EXT_ADV_ENB_EVT       39  /* Extended advertising enable event*/
#define BTA_GATTC_EXT_ADV_DISABLE_EVT   40  /* Extended advertising disable event*/
#define BTA_GATTC_STOP_EXT_ADV_SET_EVT  41  /* Extended advertising disable event*/
