...
extern void bta_av_co_audio_get_sep_info(UINT8 tsep, UINT8 *start_idx, UINT8 *max_sep_idx);
#endif

#if defined(MTK_LINUX_A2DP_PLUS) && (MTK_LINUX_A2DP_PLUS == TRUE)
extern UINT8 bta_av_get_current_codec(void);
extern UINT8* bta_av_get_current_codecInfo(void);
extern BOOLEAN bta_av_co_audio_get_aac_config(UINT8 *p_config, UINT16 *p_minmtu);
extern BOOLEAN bta_av_co_audio_get_vendor_codec_config(UINT8 *p_config, UINT16 *p_minmtu);
#endif
