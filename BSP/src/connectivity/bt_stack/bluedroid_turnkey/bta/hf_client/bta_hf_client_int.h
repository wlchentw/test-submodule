...
extern void bta_hf_client_send_at_cpbs(UINT8 storage_idx);
extern void bta_hf_client_send_at_cpbr(UINT32 idx_min, UINT32 idx_max);
extern void bta_hf_client_send_at_cscs(const char* charset);
#endif
