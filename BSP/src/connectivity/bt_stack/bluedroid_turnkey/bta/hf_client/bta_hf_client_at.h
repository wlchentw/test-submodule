...
enum
{
    ...
    BTA_HF_CLIENT_AT_CPBS_SEL,
    BTA_HF_CLIENT_AT_CPBS_SET,
    BTA_HF_CLIENT_AT_CPBR_CNT,
    BTA_HF_CLIENT_AT_CPBR_ENT,
    BTA_HF_CLIENT_AT_CSCS,
#endif
};
...
#if defined(MTK_LINUX_HFP_PHONEBOOK) && (MTK_LINUX_HFP_PHONEBOOK == TRUE)
/* Maximum number of Memory Storage */
...
#if defined(MTK_LINUX_HFP_PHONEBOOK) && (MTK_LINUX_HFP_PHONEBOOK == TRUE)
    /*CPBS: lookup table to store memory storage, default: 0, found: 1*/
