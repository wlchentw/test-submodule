...
// MTK_A2DP_SILENT_STREAM_PRIORITY begin
#ifdef MTK_A2DP_SILENT_STREAM_PRIORITY
/* API_SET_ACL_PRI_EVT */   {BTA_AV_SIGNORE,        BTA_AV_SIGNORE,         BTA_AV_INIT_SST },
#endif
// MTK_A2DP_SILENT_STREAM_PRIORITY end
...
#if defined(MTK_LINUX_A2DP_PLUS) && (MTK_LINUX_A2DP_PLUS == TRUE)
/* BTA_AV_API_CODEC_ENABLE_EVT */{BTA_AV_CODEC_ENABLE,    BTA_AV_SIGNORE,        BTA_AV_INIT_SST },
#endif
...
// MTK_A2DP_SILENT_STREAM_PRIORITY begin
#ifdef MTK_A2DP_SILENT_STREAM_PRIORITY
/* API_SET_ACL_PRI_EVT */   {BTA_AV_SIGNORE,        BTA_AV_SIGNORE,         BTA_AV_INCOMING_SST },
#endif
// MTK_A2DP_SILENT_STREAM_PRIORITY end
...
// MTK_A2DP_SILENT_STREAM_PRIORITY begin
#ifdef MTK_A2DP_SILENT_STREAM_PRIORITY
/* API_SET_ACL_PRI_EVT */   {BTA_AV_SIGNORE,        BTA_AV_SIGNORE,         BTA_AV_OPENING_SST },
#endif
// MTK_A2DP_SILENT_STREAM_PRIORITY end
...
// MTK_A2DP_SILENT_STREAM_PRIORITY begin
#ifdef MTK_A2DP_SILENT_STREAM_PRIORITY
/* API_SET_ACL_PRI_EVT */   {BTA_AV_SET_ACL_PRI,    BTA_AV_SIGNORE,         BTA_AV_OPEN_SST },
#endif
// MTK_A2DP_SILENT_STREAM_PRIORITY end
...
/* STR_WRITE_CFM_EVT */     {BTA_AV_CLR_CONG,       BTA_AV_DATA_PATH,      BTA_AV_OPEN_SST },
    ...
    defined(MTK_PTS_AV_SINK_ONLY) && (MTK_PTS_AV_SINK_ONLY == TRUE)
// pts test-- AVDTP/SNK/INT/SIG/SMG/BV-13-C
/* STR_SUSPEND_CFM_EVT */   {BTA_AV_SUSPEND_CFM,    BTA_AV_SUSPEND_CONT,   BTA_AV_OPEN_SST },
#else
...
// MTK_A2DP_SILENT_STREAM_PRIORITY begin
#ifdef MTK_A2DP_SILENT_STREAM_PRIORITY
/* API_SET_ACL_PRI_EVT */   {BTA_AV_SIGNORE,        BTA_AV_SIGNORE,         BTA_AV_RCFG_SST },
#endif
// MTK_A2DP_SILENT_STREAM_PRIORITY end
...
// MTK_A2DP_SILENT_STREAM_PRIORITY begin
#ifdef MTK_A2DP_SILENT_STREAM_PRIORITY
/* API_SET_ACL_PRI_EVT */   {BTA_AV_SIGNORE,        BTA_AV_SIGNORE,         BTA_AV_CLOSING_SST },
#endif
// MTK_A2DP_SILENT_STREAM_PRIORITY end
...
void bta_av_ssm_execute(tBTA_AV_SCB *p_scb, UINT16 event, tBTA_AV_DATA *p_data)
{
...
#if (defined(BTA_AV_DEBUG) && BTA_AV_DEBUG == TRUE)
    APPL_TRACE_DEBUG("AV Sevent(0x%x)=0x%x(%s) state=%d(%s)",
        p_scb->hndl, event, bta_av_evt_code(event), p_scb->state, bta_av_sst_code(p_scb->state));
#else
    APPL_TRACE_DEBUG("AV Sevent=0x%x state=%d", event, p_scb->state);
#endif
    ...
    for(i=0; i< BTA_AV_SACTIONS; i++)
    {
        if ((action = state_table[event][i]) != BTA_AV_SIGNORE)
        {
            ...
            APPL_TRACE_DEBUG("bta_av_ssm_execute: action:%d", action);
#endif
