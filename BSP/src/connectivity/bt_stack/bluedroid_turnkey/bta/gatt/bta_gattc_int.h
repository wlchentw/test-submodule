...
enum
{
    ...
    ,BTA_GATTC_API_SET_PREFERRED_PHY_EVT,
    BTA_GATTC_API_READ_PHY_EVT
#endif
};
...
typedef struct
{
    ...
    UINT8                   rx_phy;
    UINT16                  phy_options;
} tBTA_GATTC_API_SET_PREFERRED_PHY;

typedef struct
{
    BT_HDR                  hdr;
    BD_ADDR                 bd_addr;
} tBTA_GATTC_API_READ_PHY;
#endif
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
    tBTA_GATTC_API_SET_PREFERRED_PHY api_set_preferred_phy;
    tBTA_GATTC_API_READ_PHY          api_read_phy;
#endif
} tBTA_GATTC_DATA;
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
extern void bta_gattc_set_preferred_phy(tBTA_GATTC_DATA * p_msg);
extern void bta_gattc_read_phy(tBTA_GATTC_DATA * p_msg);
#endif
