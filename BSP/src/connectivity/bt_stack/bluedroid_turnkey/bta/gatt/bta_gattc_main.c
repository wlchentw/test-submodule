...
BOOLEAN bta_gattc_hdl_event(BT_HDR *p_msg)
{
    ...
    switch (p_msg->event)
    {
        ...
        case BTA_GATTC_API_SET_PREFERRED_PHY_EVT:
            bta_gattc_set_preferred_phy((tBTA_GATTC_DATA *) p_msg);
            break;
        case BTA_GATTC_API_READ_PHY_EVT:
            bta_gattc_read_phy((tBTA_GATTC_DATA *) p_msg);
            break;
#endif
        default:
