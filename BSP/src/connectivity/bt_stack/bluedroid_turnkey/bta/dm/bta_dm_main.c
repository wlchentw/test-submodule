...
const tBTA_DM_ACTION bta_dm_action[] =
{
    ...
    bta_dm_ble_ext_adv_data,       /* BTA_DM_API_BLE_EXT_ADV_DATA_EVT */
    bta_dm_ble_start_advertising_set,   /* BTA_DM_API_BLE_START_ADVERTISING_SET_EVT */
    bta_dm_ble_stop_advertising_set,    /* BTA_DM_API_BLE_STOP_ADVERTISING_SET_EVT */
    bta_dm_ble_set_peri_param,           /* BTA_DM_API_BLE_ADV_SET_PERI_PARAM_EVT */
    bta_dm_ble_peri_adv_enable,          /* BTA_DM_API_BLE_ADV_PERI_ENABLE_EVT */
    bta_dm_ble_set_advertising_data,    /* BTA_DM_API_BLE_ADV_SET_ADVERTISING_DATA_EVT */
    bta_dm_ble_advertising_set_param,   /* BTA_DM_API_BLE_ADV_SET_PARAM_EVT */
#endif
#endif
