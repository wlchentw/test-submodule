...
enum
{
    ...
    BTA_DM_API_BLE_EXT_ADV_DATA_EVT,
    BTA_DM_API_BLE_START_ADVERTISING_SET_EVT,
    BTA_DM_API_BLE_STOP_ADVERTISING_SET_EVT,
    BTA_DM_API_BLE_ADV_SET_PERI_PARAM_EVT,
    BTA_DM_API_BLE_ADV_PERI_ENABLE_EVT,
    BTA_DM_API_BLE_ADV_SET_ADVERTISING_DATA_EVT,
    BTA_DM_API_BLE_ADV_SET_PARAM_EVT,
#endif
#endif
...
}tBTA_DM_API_BLE_ADVERTISING_PARAM;
...
typedef struct
{
    ...
    tBTA_BLE_MULTI_ADV_CBACK       *p_cback;
    void                           *p_ref;
    tBTA_BLE_ADVERTISING_SET   *p_adv_info;
}tBTA_DM_API_BLE_START_ADVERTISING_SET;
...
typedef struct
{
    ...
    tBTA_BLE_MULTI_ADV_CBACK       *p_cback;
    void                           *p_ref;
}tBTA_DM_API_BLE_PERI_ADV_ENABLE;
...
typedef struct
{
    ...
    tBTA_BLE_MULTI_ADV_CBACK       *p_cback;
    void                           *p_ref;
    tBTA_BLE_PERI_ADV_DATA         *p_adv_data;
}tBTA_DM_API_BLE_ADVERTISING_DATA;
#endif
/* peri_disable can use tBTA_DM_API_BLE_MULTI_ADV_DISABLE*/
typedef struct
{
    BT_HDR                  hdr;
    UINT8                   inst_id;
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
    tBTA_DM_API_BLE_EXT_ADV_DATA        ble_ext_adv_data;
    tBTA_DM_API_BLE_START_ADVERTISING_SET ble_start_advertising_set;
    tBTA_DM_API_BLE_PERI_PARAM          ble_set_peri_param;
    tBTA_DM_API_BLE_PERI_ADV_ENABLE     ble_peri_adv_enable;
    tBTA_DM_API_BLE_ADVERTISING_DATA    ble_set_advertising_data;
    tBTA_DM_API_BLE_ADVERTISING_PARAM   ble_adv_set_param;
#endif
#if defined(MTK_LINUX_GATTC_RPA) && (MTK_LINUX_GATTC_RPA == TRUE)
...
typedef struct
{
    ...
    tBTA_DM_SEC_CBACK           *p_sec_cback; /* bte_dm_evt */
#if ((defined BLE_INCLUDED) && (BLE_INCLUDED == TRUE))
    tBTA_BLE_SCAN_SETUP_CBACK   *p_setup_cback;
...
#if defined(MTK_BLE_BT_5_0) && (MTK_BLE_BT_5_0 == TRUE)
extern void bta_dm_ble_ext_adv_data(tBTA_DM_MSG *p_data);
extern void bta_dm_ble_start_advertising_set(tBTA_DM_MSG *p_data);
extern void bta_dm_ble_stop_advertising_set(tBTA_DM_MSG *p_data);
extern void bta_dm_ble_set_peri_param(tBTA_DM_MSG *p_data);
extern void bta_dm_ble_peri_adv_enable(tBTA_DM_MSG *p_data);
extern void bta_dm_ble_set_advertising_data(tBTA_DM_MSG *p_data);
extern void bta_dm_ble_advertising_set_param(tBTA_DM_MSG *p_data);
