...
rem push sigma related program to the directory "/data/", so you should confirm this directory can been read and write on your platform
...
adb push .\sw\ping_sigma /data/ 

adb shell chmod 777 /data/busybox-full
adb shell chmod 777 /data/getpid.sh
adb shell chmod 777 /data/getpstats.sh
adb shell chmod 777 /data/ipconfig.txt
adb shell chmod 777 /data/mtk_p2p_getipconfig.sh
adb shell chmod 777 /data/ndsend
adb shell chmod 777 /data/stoping.sh
adb shell chmod 777 /data/updatepid.sh
adb shell chmod 777 /data/wfaping.sh
adb shell chmod 777 /data/wfav6ping.sh
adb shell chmod 777 /data/wfa_dut
...
adb shell chmod 777 /data/ping_sigma
