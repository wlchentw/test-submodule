...
def gen_final_h_file(in_h_file,out_h_file):
	...
	of.write("static unsigned char rsa_modulus[256] = \n")
	of.write("{\n")
	of.write(inf.read())
	of.write("};\n")
...
if __name__ == "__main__":
	if len(sys.argv) != 3:
		print("Usage: %s prvkeypath output_dir" % sys.argv[0])
		sys.exit(3)

	prvkeypath = str(sys.argv[1]);
	output_dir = str(sys.argv[2])
	key_file_path = prvkeypath
	...
	target_h_file = output_dir + "/nfsb_key_modulus.h"
