...
DTB_IMAGE_OUT := $(KERNEL_OUT)/arch/$(TARGET_ARCH)/boot/dts/mediatek/$(KERNEL_DTB_NAME)
BUILT_DTB_TARGET := $(PRODUCT_OUT)/fdt
...
$(BUILT_DTB_TARGET): $(BUILT_KERNEL_TARGET) $(LOCAL_PATH)/Android.mk | $(ACP)
	cp $(DTB_IMAGE_OUT) $(BUILT_DTB_TARGET)
...
$(INSTALLED_KERNEL_TARGET): $(BUILT_KERNEL_TARGET) $(BUILT_DTB_TARGET) $(LOCAL_PATH)/Android.mk | $(ACP)
	$(copy-file-to-target)
