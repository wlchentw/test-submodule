...
typedef struct tagNTXHWCFG_VAL { 
	...
	unsigned char bFL_Channels; // FL channels .
	unsigned char bTTS; // TTS .
	unsigned char bTestFlags; // Test flags .
	unsigned char bEPD_CFA_REV; // EPD CFA revision/generation .
	unsigned char bPanelModel; // Panel model .
	unsigned char bACEP_PWR;//ACEP PWR
	unsigned char bBootPartNo;//Boot partition no,bootloader should clear this after accepted .
	unsigned char bEPD_CFA_Rotate; // EPD CFA revision/generation .
} NTXHWCFG_VAL ;
...
#define NTX_HWCONFIG_FLDS_TOTAL		sizeof(NTXHWCFG_VAL)
...
extern const char * gszTTS[];// TTS .
extern const char * gszPanelModel[];// TTS .
...
#define HWCFG_FLDIDX_FL_CHNS							69 // v3.1
#define HWCFG_FLDIDX_TTS									70 // v3.2
#define HWCFG_FLDIDX_TEST_Flags						71 // v3.3
#define HWCFG_FLDIDX_EPD_CFA_REV						72 // v3.3
#define HWCFG_FLDIDX_PANEL_MODEL						73 // v3.4
#define HWCFG_FLDIDX_ACEP_PWR					74 // v3.6
#define HWCFG_FLDIDX_BOOT_PARTNO					75 // v3.7
#define HWCFG_FLDIDX_EPD_CFA_Rotate					76 // v3.8.
...
int NtxHwCfg_GetTotalFlds(void);//\A8\FA\B1o\A6@\A6\B3\B4X\AD\D3\C4\E6\A6\EC.
int NtxHwCfg_GetFldVal(int iFldIdx,HwConfigField *O_ptHwCfgFld);//\A8\FA\B1o\A4v\A9w\B8q\AA\BA\C4\E6\A6\EC\AD\C8.
unsigned char NtxHwCfg_FldStrVal2Val(int iFldIdx,char *szFldStrVal);//\C4\E6\A6쪺\A6r\A6\EA\AD\C8\C2ഫ\AC\B0\C4\E6\A6\EC.
const char *NtxHwCfg_FldVal2StrVal(int iFldIdx,unsigned char bFldVal);//\C4\E6\A6쪺\AD\C8\C2ഫ\AC\B0\A6r\A6\EA\AD\C8.
...
int NtxHwCfg_ChkCfgHeader(NTX_HWCONFIG *pHdr);//\C0ˬd\B2պA\AA\ED\C0Y,\AA\A9\A5\BB.
int NtxHwCfg_CfgUpgrade(NTX_HWCONFIG *pHdr);//\AE榡\A4ɯŦܤu\A8\E3\A4@\ADP\AA\BA\AA\A9\A5\BB.

int NtxHwCfg_GetCfgTotalFlds(NTX_HWCONFIG *pHdr);//\A8\FA\B1o\B2պA\C1`\A6@\A6\B3\B4X\AD\D3\C4\E6\A6\EC.
...
#define NTXHWCFG_CFA_FLAG(_flags,_bit_n)	((_flags)&(0x01<<(_bit_n)))?1:0
