...
#define HWTCON_FLAG_CFA_SKIP				0x00008000 // force use B/W even CFA mode is enabled .
													   
#define HWTCON_FLAG_CFA_FLDS_MASK			0x00007f00
////////////////////////////////////////////////////
// chose one of following CFA modes . 
// Eink color enhance algorithms : 
#define HWTCON_FLAG_CFA_EINK_NORMAL			0x00000100 // equal to EINK Gain 1 
#define HWTCON_FLAG_CFA_EINK_G1				0x00000100 // EINK Gain algorithm gain value=1.
#define HWTCON_FLAG_CFA_EINK_AIE_S4			0x00000200 // EINK AIE algorithm S4
#define HWTCON_FLAG_CFA_EINK_AIE_S7			0x00000300 // EINK AIE algorithm S7
#define HWTCON_FLAG_CFA_EINK_AIE_S9			0x00000400 // EINK AIE algorithm S9
#define HWTCON_FLAG_CFA_EINK_G0				0x00000500 // EINK Gain algorithm gain value=0.
#define HWTCON_FLAG_CFA_EINK_G2				0x00000600 // EINK Gain algorithm gain value=2.
...
/* Get the currently CFA mode of global setting */
#define HWTCON_SET_CFA_MODE		_IOW(HWTCON_IOCTL_MAGIC_NUMBER, 0x50, __u32)
/* Set the currently CFA mode of global setting */
#define HWTCON_GET_CFA_MODE		_IOW(HWTCON_IOCTL_MAGIC_NUMBER, 0x51, __u32)
