...
//#endif //] __KERNEL__
...
#ifdef __KERNEL__ //[ 
#if 0
	#define GALLEN_DBG_PRINT(fmt,args...)		printk(fmt,##args)
...
#else
	#define GALLEN_DBG_PRINT(fmt,args...)		pr_debug(fmt,##args)
	#define GALLEN_PRINT(fmt,args...)		pr_info(fmt,##args)
	#define GALLEN_ERR_PRINT(fmt,args...)		pr_err(fmt,##args)
	#define GALLEN_WARNING_PRINT(fmt,args...)		pr_warning(fmt,##args)
#endif
	...
	#define GALLEN_DBG_PRINT(fmt,args...)		printf(fmt,##args)
...
{\
	...
	#define dbgENTER()		GALLEN_DBG_PRINT("%s(%d) : Enter %s\n",__FILE__,__LINE__,__FUNCTION__)
	#define dbgLEAVE()		GALLEN_DBG_PRINT("%s(%d) : Leave %s\n",__FILE__,__LINE__,__FUNCTION__)
	#define DBG_MSG(fmt,args...)					GALLEN_DBG_PRINT(fmt,##args)
	#define DBG_MSG_FLUSH(fmt,args...)				GALLEN_DBG_PRINT(fmt,##args)
	#define ERR_MSG(fmt,args...)					GALLEN_ERR_PRINT(fmt,##args)
	#define WARNNING_MSG(fmt,args...)			GALLEN_WARNING_PRINT(fmt,##args)
	#define WARNING_MSG(fmt,args...)			GALLEN_WARNING_PRINT(fmt,##args)
#endif
