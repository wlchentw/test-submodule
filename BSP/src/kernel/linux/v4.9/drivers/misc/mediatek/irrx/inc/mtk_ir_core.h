...
#define CONFIG_IR_LEARN_SUPPORT 1
...
#define IRRX_IO_MAGIC   's'
#define CMD_IRRX_SET_LEARN_DATA     _IOW(IRRX_IO_MAGIC, 1, int)
#define CMD_IRRX_GET_LEARN_DATA     _IOR(IRRX_IO_MAGIC, 2, int)
#define CMD_IRRX_SET_LEARN_TIMEOUT  _IOW(IRRX_IO_MAGIC, 3, int)
...
extern struct _IRRX_IO_T ir_learned_data[];
#define MAX_LEARNED_KEY (9)
#endif
...
#if CONFIG_IR_LEARN_SUPPORT
extern u8 *pulse_width_check(void);
extern u32 ir_learned_key_match(void);
extern u8 *get_ir_pluse_data(void);
#endif
#endif
