...
#define THERMAL_NAME "mt8518-thermal"
...
static void thermal_cal_prepare(struct device *dev)
{
	...
	/* ADC_CALI_EN_T(1b) *(0x10009280)[0]*/
	g_adc_cali_en_t = (calefuse1 & 0x00000001);
	if (g_adc_cali_en_t) {
		/* ADC_GE_T [9:0] *(0x10009284)[31:22]*/
		g_adc_ge_t = (calefuse2 & 0xFFC00000)>>22;
		/* ADC_OE_T [9:0] *(0x10009284)[21:12]*/
		g_adc_oe_t = (calefuse2 & 0x003FF000)>>12;
		/* O_VTSMCU1 (9b) *(0x10009280)[25:17]*/
		g_o_vtsmcu1 = (calefuse1 & 0x03FE0000)>>17;
		/* O_VTSMCU2 (9b) *(0x10009280)[16:8]*/
		g_o_vtsmcu2 = (calefuse1 & 0x0001FF00)>>8;
		/* O_VTSMCU3 (9b) *(0x10009288)[8:0]*/
		g_o_vtsmcu3 = calefuse3 & 0x000001FF;
		/* DEGC_cali (6b) *(0x10009280)[6:1]*/
		g_degc_cali = (calefuse1 & 0x0000007E)>>1;
		/* O_SLOPE_SIGN (1b) *(0x10009280)[7]*/
		g_o_slope_sign = (calefuse1 & 0x00000080)>>7;
		/* O_SLOPE (6b) *(0x10009280)[31:26]*/
		g_o_slope = (calefuse1 & 0xFC000000)>>26;
		/* O_VTSABB (9b) *(0x10009284)[11:3]*/
		g_o_vtsabb = (calefuse2 & 0x00000FF8)>>3;
		/* ID (1b) *(0x10009284)[2]*/
		g_id = (calefuse2 & 0x00000004)>>2;
...
static int get_io_reg_base(struct platform_device *pdev)
{
	...
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt8518-auxadc");
	...
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt8518-infracfg");
