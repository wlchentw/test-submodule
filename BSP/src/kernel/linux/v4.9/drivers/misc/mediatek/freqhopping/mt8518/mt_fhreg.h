...
#define REG_AP_PLL_CON0                                                        \
	REG_APMIX_ADDR(0x0000) /* mt8518 apmixedsys, bit#24 is FHCTL clock */
#define REG_FHCTL_HP_EN REG_APMIX_ADDR(0x0014) /* mt8518 apmixedsys */
...
#define FH_DDS_MASK DDS_21b
#define FH_DVFS_MASK DDS_21b
#define UNINIT_DDS 0
...
#define FH_FHCTL0_CLK_EN (0x1U << 0)
#define FH_FHCTL1_CLK_EN (0x1U << 1)
#define FH_FHCTL3_CLK_EN (0x1U << 3)
#define FH_FHCTL4_CLK_EN (0x1U << 4)

/* mt8518 apmixedsys MB */
/* **************************************************** */
...
#define REG_LVDSPLL_CON0                                                       \
	REG_APMIX_ADDR(                                                        \
		0x01E0) /* /< FHCTL unsupport, VCODECPLL_CON0 is useless */

/*CON1, DDS value */
#define REG_ARMCA7PLL_CON1 REG_APMIX_ADDR(0x0104)
#define REG_MAINPLL_CON1 REG_APMIX_ADDR(0x0124)
#define REG_MEMPLL_CON1                                                        \
	REG_DDRPHY_ADDR(0x0600) /* /< Bit[30:10] DDS,  Bit[31] Update DDS */
#define REG_MMPLL_CON1 REG_APMIX_ADDR(0x0164)
#define REG_TVDPLL_CON1 REG_APMIX_ADDR(0x01C4)
#define REG_LVDSPLL_CON1                                                       \
	REG_APMIX_ADDR(                                                        \
		0x01E4) /* /< FHCTL unsupport, VCODECPLL_CON0 is useless */
/* **************************************************** */
/* mt8518 apmixedsys ME */
