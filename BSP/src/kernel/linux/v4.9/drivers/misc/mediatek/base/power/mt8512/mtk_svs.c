...
struct svs_bank svs_mt8110l_banks[] = {
	{
		.of_compatible		= "mediatek,mt8110-svs-cpu-little",
		.sw_id			= SVS_CPU_LITTLE,
		.hw_id			= 0,
...
struct svs_bank svs_mt8110t_banks[] = {
	{
		.of_compatible		= "mediatek,mt8110-svs-cpu-little",
		.sw_id			= SVS_CPU_LITTLE,
		.hw_id			= 0,
...
static const struct svs_platform svs_mt8110l_platform = {
	.name		= "mt8110l-svs",
	.banks		= svs_mt8110l_banks,
	.efuse_parsing	= svs_mt8512_efuse_parsing,
	.regs		= svs_regs_v2,
	.fake_efuse	= false,
	.bank_num	= 1,
...
static const struct svs_platform svs_mt8110t_platform = {
	.name		= "mt8110t-svs",
	.banks		= svs_mt8110t_banks,
	.efuse_parsing	= svs_mt8512_efuse_parsing,
	.regs		= svs_regs_v2,
	.fake_efuse	= false,
	.bank_num	= 1,
...
struct svs_bank_ops svs_mt8112_banks_ops = {
	.set_freqs_pct	= svs_set_freqs_pct_v2,
	.get_vops	= svs_get_vops_v2,
};

struct svs_bank svs_mt8112_banks[1] = {
	{
		.of_compatible		= "mediatek,mt8112-svs-cpu-little",
		.sw_id			= SVS_CPU_LITTLE,
		.hw_id			= 0,
		.ops			= &svs_mt8112_banks_ops,
		.zone_name		= "tzts1",
		.buck_name		= "proc",
		.mtcmos_request		= false,
		.init01_volt_flag	= SVS_INIT01_VOLT_INC_ONLY,
...
static const struct svs_platform svs_mt8112_platform = {
	.name		= "mt8112-svs",
	.banks		= svs_mt8112_banks,
	.efuse_parsing	= svs_mt8512_efuse_parsing,
	.regs		= svs_regs_v2,
	.fake_efuse	= false,
	.bank_num	= 1,
...
static const struct of_device_id mtk_svs_of_match[] = {
	{
		...
		.data = &svs_mt8110l_platform,
	}, {
		/* sentinel */
		.compatible = "mediatek,mt8110t-svs",
		.data = &svs_mt8110t_platform,
	}, {
		/* sentinel */
		.compatible = "mediatek,mt8112-svs",
		.data = &svs_mt8112_platform,
	},
};
