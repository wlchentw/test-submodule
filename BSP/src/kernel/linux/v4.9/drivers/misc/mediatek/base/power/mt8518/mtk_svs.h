...
#define SVS_CTRL_CPU  0
#define NR_SVS_CTRL   1
#define SVS_DET_CPU   SVS_CTRL_CPU
#define NR_SVS_DET    1
...
extern int mt_svs_status(int id);
...
extern void svs_set_pi_efuse(int id, unsigned int pi_efuse);
