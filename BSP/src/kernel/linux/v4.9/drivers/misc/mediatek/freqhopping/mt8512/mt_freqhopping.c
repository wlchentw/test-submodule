...
static const struct freqhopping_ssc g_pll_ssc_tbl[FH_PLL_NUM][4] = {
	...
	{
	 {0, 0, 0, 0, 0, 0},
	 {PLL_IDX__DEF, 0, 9, 0, 8, UNINIT_DDS},	/* 0% ~ -8% */
	 },
...
static int fh_dumpregs_proc_read(struct seq_file *m, void *v)
{
	...
	for (i = 0; i < FH_PLL_NUM; ++i) {
		if (g_reg_cfg[i] == REG_FHCTL_NOT_SUPPORT)
			seq_printf(m, "PLL%d;Not Support \r\n", i);
		else {
			const unsigned int mon = fh_read32(g_reg_mon[i]);
			const unsigned int dds = mon & FH_DDS_MASK;

			seq_printf(m,
				"FHCTL%d CFG, UPDNLMT, DVFS, DDS, MON\r\n", i);
...
static void __reg_tbl_init(void)
{
	...
	const unsigned long reg_dds[] = {
		...
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL_NOT_SUPPORT, REG_FHCTL5_DDS,
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL7_DDS, REG_FHCTL8_DDS,
		REG_FHCTL9_DDS
	};

	const unsigned long reg_cfg[] = {
		REG_FHCTL0_CFG, REG_FHCTL1_CFG, REG_FHCTL2_CFG,
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL_NOT_SUPPORT, REG_FHCTL5_CFG,
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL7_CFG, REG_FHCTL8_CFG,
		REG_FHCTL9_CFG
	};

	const unsigned long reg_updnlmt[] = {
		REG_FHCTL0_UPDNLMT, REG_FHCTL1_UPDNLMT, REG_FHCTL2_UPDNLMT,
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL_NOT_SUPPORT,
		REG_FHCTL5_UPDNLMT, REG_FHCTL_NOT_SUPPORT, REG_FHCTL7_UPDNLMT,
		REG_FHCTL8_UPDNLMT, REG_FHCTL9_UPDNLMT
	};

	const unsigned long reg_mon[] = {
		REG_FHCTL0_MON, REG_FHCTL1_MON, REG_FHCTL2_MON,
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL_NOT_SUPPORT, REG_FHCTL5_MON,
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL7_MON, REG_FHCTL8_MON,
		REG_FHCTL9_MON
	};

	const unsigned long reg_dvfs[] = {
		REG_FHCTL0_DVFS, REG_FHCTL1_DVFS, REG_FHCTL2_DVFS,
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL_NOT_SUPPORT, REG_FHCTL5_DVFS,
		REG_FHCTL_NOT_SUPPORT, REG_FHCTL7_DVFS, REG_FHCTL8_DVFS,
		REG_FHCTL9_DVFS
	};

	const unsigned long reg_pll_con0[] = {
		REG_FH_PLL0_CON0, REG_FH_PLL1_CON0, REG_FH_PLL2_CON0,
		REG_PLL_NOT_SUPPORT, REG_PLL_NOT_SUPPORT, REG_FH_PLL5_CON0,
		REG_PLL_NOT_SUPPORT, REG_FH_PLL7_CON0, REG_FH_PLL8_CON0,
		REG_FH_PLL9_CON0
	};

	const unsigned long reg_pll_con1[] = {
		REG_FH_PLL0_CON1, REG_FH_PLL1_CON1, REG_FH_PLL2_CON1,
		REG_PLL_NOT_SUPPORT, REG_PLL_NOT_SUPPORT, REG_FH_PLL5_CON1,
		REG_PLL_NOT_SUPPORT, REG_FH_PLL7_CON1, REG_FH_PLL8_CON1,
		REG_FH_PLL9_CON1
	};
...
static int __reg_base_addr_init(void)
{
	...
	fhctl_node =
		of_find_compatible_node(NULL, NULL, "mediatek,mt8512-fhctl");
