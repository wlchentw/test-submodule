...
#endif
/* Define */
#define DUAL_FREQ_HIGH 1600
#define DUAL_FREQ_LOW 600
#define DATA_RATE_THRESHOLD 15
#define MPLL_CON0_OFFSET 0x340
#define MPLL_CON1_OFFSET 0x344
...
#define DDRPHY_CHA_SHU1_PLL7 (DDRPHY_AO_CHA_BASE_ADDR + SHU1_PLL7)
#define DDRPHY_CHB_SHU1_PLL7 (DDRPHY_AO_CHB_BASE_ADDR + SHU1_PLL7)

#define DDRPHY_MISC_STBERR_RK0_R (DRAMC_AO_BASE_ADDR + 0x510)

#define DRAMC_AO_ARBCTL (DRAMC_AO_BASE_ADDR + 0x010)
#define DRAMC_REG_SHUSTATUS (DRAMC_AO_BASE_ADDR + 0x0E4)

#define DDRPHY_SHU1_PLL5 (DDRPHY_AO_CHA_BASE_ADDR + 0x0D94)
#define DDRPHY_SHU1_PLL8 (DDRPHY_AO_CHA_BASE_ADDR + 0x0DA0)

#define DDRPHY_SHU1_PLL7 (DDRPHY_AO_CHA_BASE_ADDR + 0x0D9C)
#define DDRPHY_SHU1_PLL10 (DDRPHY_AO_CHA_BASE_ADDR + 0x0DA8)

#define DDRPHY_SHU1_CA_CMD6 (DDRPHY_AO_CHA_BASE_ADDR + 0x0D18)
