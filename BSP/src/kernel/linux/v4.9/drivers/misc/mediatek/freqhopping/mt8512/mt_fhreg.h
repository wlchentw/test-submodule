...
#define REG_FHCTL_NOT_SUPPORT	0xdeadbeef
...
#define REG_FH_PLL7_CON0    REG_APMIX_ADDR(0x0374) /* IPPLL */
#define REG_FH_PLL8_CON0    REG_APMIX_ADDR(0x0390) /* DSPPLL */
#define REG_FH_PLL9_CON0    REG_APMIX_ADDR(0x03A0) /* TCONPLL */
...
#define REG_FH_PLL7_CON1    REG_APMIX_ADDR(0x0378) /* IPPLL */
#define REG_FH_PLL8_CON1    REG_APMIX_ADDR(0x0394) /* DSPPLL */
#define REG_FH_PLL9_CON1    REG_APMIX_ADDR(0x03A4) /* TCONPLL */
