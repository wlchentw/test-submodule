...
void setHDMITX_ColorDepthPhase(unsigned char ColorDepth,
...
void hdmitx_SetCSCScale(unsigned char bInputMode,
...
extern int fgDDC2DataRead(char bDevice, char bData_Addr,
