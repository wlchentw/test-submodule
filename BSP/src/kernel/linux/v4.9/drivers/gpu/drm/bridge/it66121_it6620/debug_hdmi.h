...
#define HDMITX_DEBUG_PRINTF(fmt, arg...) pr_debug(fmt, ##arg)
#define HDMITX_DEBUG_PRINTF1(fmt, arg...) pr_debug(fmt, ##arg)
#define HDMITX_DEBUG_PRINTF2(fmt, arg...) pr_debug(fmt, ##arg)
#define HDMITX_DEBUG_PRINTF3(fmt, arg...) pr_debug(fmt, ##arg)
...
extern unsigned char IT66121_LOG_on;
