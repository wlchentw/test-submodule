...
#define MT8518_MUTEX_MOD_DISP_DBI		BIT(0)
#define MT8518_MUTEX_MOD_DISP_OVL		BIT(1)
#define MT8518_MUTEX_MOD_DISP_COLOR		BIT(2)
#define MT8518_MUTEX_MOD_DISP_GAMMA		BIT(3)
#define MT8518_MUTEX_MOD_DISP_PWM		BIT(4)
#define MT8518_MUTEX_MOD_DISP_RDMA		BIT(5)

#define MUTEX_SOF_SINGLE_MODE		0
#define MUTEX_SOF_DBI			1
...
#define MT8518_REG_CONFIG_DISP_RDMA_SOUT_SEL	0x890
#define MT8518_DISP_RDMA_SOUT_SEL	BIT(0)
#define MT8518_SELECT_DBI_OUTPUT	0x0
#define MT8518_SELECT_DPI_OUTPUT	0x1
...
static const unsigned int mt8518_mutex_mod[DDP_COMPONENT_ID_MAX] = {
	[DDP_COMPONENT_DBI] = MT8518_MUTEX_MOD_DISP_DBI,
	[DDP_COMPONENT_OVL0] = MT8518_MUTEX_MOD_DISP_OVL,
	[DDP_COMPONENT_COLOR0] = MT8518_MUTEX_MOD_DISP_COLOR,
	[DDP_COMPONENT_GAMMA] = MT8518_MUTEX_MOD_DISP_GAMMA,
	[DDP_COMPONENT_PWM0] = MT8518_MUTEX_MOD_DISP_PWM,
	[DDP_COMPONENT_RDMA0] = MT8518_MUTEX_MOD_DISP_RDMA,
};
...
void mt8518_ddp_connect_path(void __iomem *config_regs, int path_id)
{
	...
	if (path_id == 0) {
		reg = readl_relaxed(config_regs +
				MT8518_REG_CONFIG_DISP_RDMA_SOUT_SEL);
		reg &= 0xFFFFFFFE;
		reg |= MT8518_SELECT_DBI_OUTPUT;
		writel_relaxed(reg, config_regs +
				MT8518_REG_CONFIG_DISP_RDMA_SOUT_SEL);
	} else {
		reg = readl_relaxed(config_regs +
				MT8518_REG_CONFIG_DISP_RDMA_SOUT_SEL);
		reg &= 0xFFFFFFFE;
		reg |= MT8518_SELECT_DPI_OUTPUT;
		writel_relaxed(reg, config_regs +
				MT8518_REG_CONFIG_DISP_RDMA_SOUT_SEL);
	}
}
...
static const struct of_device_id ddp_driver_dt_match[] = {
	...
	{ .compatible = "mediatek,mt8518-disp-mutex", .data = mt8518_mutex_mod},
	{},
};
