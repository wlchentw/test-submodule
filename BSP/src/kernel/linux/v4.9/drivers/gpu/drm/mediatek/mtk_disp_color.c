...
#define DISP_COLOR_START_MT8518		0x0c00
...
static const struct mtk_disp_color_data mt8518_color_driver_data = {
	.color_offset = DISP_COLOR_START_MT8518,
};
