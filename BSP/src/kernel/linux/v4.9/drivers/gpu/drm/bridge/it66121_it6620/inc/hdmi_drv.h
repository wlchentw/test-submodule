...
enum HDMI_POLARITY { HDMI_POLARITY_RISING = 0, HDMI_POLARITY_FALLING = 1 };

enum HDMI_CLOCK_PHASE { HDMI_CLOCK_PHASE_0 = 0, HDMI_CLOCK_PHASE_90 = 1 };

enum HDMI_COLOR_ORDER { HDMI_COLOR_ORDER_RGB = 0, HDMI_COLOR_ORDER_BGR = 1 };
...
enum HDMI_3D_FORMAT_ENUM { HDMI_2D, HDMI_3D_SBS, HDMI_3D_TAB, HDMI_3D_FP };
...
enum HDMI_AUDIO_INPUT_TYPE_T { SV_I2S = 0, SV_SPDIF };
...
union AUDIO_DEC_OUTPUT_CHANNEL_UNION_T {
	struct HDMI_AUDIO_DEC_OUTPUT_CHANNEL_T
		bit; /* HDMI_AUDIO_DEC_OUTPUT_CHANNEL_T */
	unsigned short word;
};
...
/*For it6620 I2C function*/
extern int it6620_i2c_read_byte(u8 Addr, u8 u8Offset, u8 *data);
extern int it6620_i2c_write_byte(u8 Addr, u8 u8Offset, u8 data);
...
extern unsigned char Cec_Pab;
extern unsigned char Cec_Pcd;
extern unsigned char notify_hpd_flag;
...
extern void vHdmiDDCGetGpio(void);
extern void ddc_DBG_Init(void);
