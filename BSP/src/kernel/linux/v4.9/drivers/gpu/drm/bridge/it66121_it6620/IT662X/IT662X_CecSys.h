 ...
 *****************************************
 *   @file   <IT662X_CecSys.h>
 *   @author Hojim.Tseng@ite.com.tw
 *   @date   2019/01/16
 *   @fileversion: ITE_eARC_RX_0.70
 */
#ifndef _IT662X_CECSYS_H_
#define _IT662X_CECSYS_H_

/*#include "../IT6634_Customer/IT6634_IO.h"*/
...
#define CEC_TX_REQ_PA_SHIFT (6)
#define CEC_TX_REQ_PA_MASK (1 << CEC_TX_REQ_PA_SHIFT)
#define CEC_TX_REQ_PA_SET (1 << CEC_TX_REQ_PA_SHIFT)
#define CEC_TX_REQ_PA_CLR (0x00)

#define CEC_LIST_DEV_SHIFT (4)
#define CEC_LIST_DEV_MASK (1 << CEC_LIST_DEV_SHIFT)
#define CEC_LIST_DEV_SET (0x00)
#define CEC_LIST_DEV_CLR (1 << CEC_LIST_DEV_SHIFT)

#define CEC_LIST_ACTIVE_SHIFT (5)
#define CEC_LIST_ACTIVE_MASK (1 << CEC_LIST_ACTIVE_SHIFT)
#define CEC_LIST_ACTIVE_SET (0x00)
#define CEC_LIST_ACTIVE_CLR (1 << CEC_LIST_ACTIVE_SHIFT)
...
#define CEC_SYS_ADO_ARC_SHIFT (0)
#define CEC_SYS_ADO_ARC_MASK (1 << CEC_SYS_ADO_ARC_SHIFT)
#define CEC_SYS_ADO_ARC_ON (1 << CEC_SYS_ADO_ARC_SHIFT)
#define CEC_SYS_ADO_ARC_OFF (0x00)

#define CEC_SYS_ADO_STA_SHIFT (1)
#define CEC_SYS_ADO_STA_MASK (1 << CEC_SYS_ADO_STA_SHIFT)
#define CEC_SYS_ADO_STA_ON (1 << CEC_SYS_ADO_STA_SHIFT) // unMute Speaker here
#define CEC_SYS_ADO_STA_OFF (0x00)

#define CEC_SYS_ADO_POWER_SHIFT (2)
#define CEC_SYS_ADO_POWER_MASK (3 << CEC_SYS_ADO_POWER_SHIFT)
#define CEC_SYS_ADO_POWER_STANDBY (1 << CEC_SYS_ADO_POWER_SHIFT)
#define CEC_SYS_ADO_POWER_STANDBY2ON (2 << CEC_SYS_ADO_POWER_SHIFT)
#define CEC_SYS_ADO_POWER_ON2STANDBY (3 << CEC_SYS_ADO_POWER_SHIFT)
#define CEC_SYS_ADO_POWER_ON (0x00)

#define CEC_SYS_ADO_TX_MUTE_SHIFT (4)
#define CEC_SYS_ADO_TX_MUTE_MASK (1 << CEC_SYS_ADO_TX_MUTE_SHIFT)
#define CEC_SYS_ADO_TX_MUTE_SET (1 << CEC_SYS_ADO_TX_MUTE_SHIFT)
#define CEC_SYS_ADO_TX_MUTE_CLR (0x00)
...
typedef enum _CEC_COMMAND {
	...
	eActiveSource = 0x82, /* follower:TV, switch	--> Broadcst ,*/
				 /*Directly address*/
	...
	eRequestActiveSource =
		0x85,	  /* follower:switch		--> Broadcst	,*/
		/*AVR to request active source when Audio ocntrol feature*/
				  /*is active*/
	...
	eReportShortAudioDescriptor = 0xA3,
	eRequestShortAudioDescriptor = 0xA4,
...
typedef enum {
	eDisplayDedaultTime = 0x00,
	eDisplayUntilClear = 0x40,
	eClearPreviousMessage = 0x80,
	eReserved = 0xC0
} DisPlayControl;

typedef enum { eActive = 0, eDeactive, eQuery } MenuRequestType;

typedef enum { eActived = 0, eDeactived } MenuStatus;
...
typedef struct _CecSys {
	...
	iTE_u8 u8Stage;
	iTE_u8 u8SelPort;
	iTE_u16 u16AdoFmtIdList;
	iTE_u8 u8AdoReqPaAB, u8AdoReqPaCD;
} CecSys;
...
/*#if(En_eARCTX==TRUE)*/
void CecSys_TxAudioTest(iTE_u8 u8CecSysCmd);
void CecSys_TVArcHandler(eCEC_CMD cmd);
void CecSys_ForceARCTX_terminated(void);
void CecSys_ARC_Start(void);
void CecSys_StatePolling(void);
