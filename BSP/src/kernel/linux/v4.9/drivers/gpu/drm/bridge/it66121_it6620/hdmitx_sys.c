...
_CODE HDMITXDEV
	InstanceData = {
		...
		/* Video Property */
		/* /////////////////////////////////////////////// */
		INPUT_SIGNAL_TYPE, /* unsigned char bInputVideoSignalType ; */
...
unsigned char Cec_Pab;
unsigned char Cec_Pcd;
...
unsigned char tmp_HPD, tmp_HPDChange, notify_hpd_flag;
/* static int tim=0; */
...
/* HDMITX_DisableVideoOutput(); */
			...
			it66121_bChangeAudio = TRUE;
#endif
/***********just for it66121 pattern***************/
			hdmiTx_pattern_interface();
/*********************************************/
...
void HDMITX_MonitorInputVideoChange(void)
{
	...
	HDMITX_DEBUG_PRINTF((
		"HDMITX_MonitorInputVideoChange : pclk=%lu, ht=%u, vt=%u, dif=%lu\n",
	...
	for (offset = 4; offset < End;) {
		...
		case 0x03: /* Vendor Specific Data Block ; */
			...
			if (RxCapability.IEEEOUI == 0x0C03) {
				...
				Cec_Pab = RxCapability.PA[0];
				Cec_Pcd = RxCapability.PA[1];
				if (count > 5)
					RxCapability.dc.uc =
