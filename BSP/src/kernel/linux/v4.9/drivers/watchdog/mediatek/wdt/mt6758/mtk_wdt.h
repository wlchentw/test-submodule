...
#define MTK_WDT_LATCH_CTL2_MCU_DFD_TIMEOUT_MASK	\
	(0x7F << MTK_WDT_LATCH_CTL2_MCU_DFD_TIMEOUT_SHIFT)
#define MTK_WDT_LATCH_CTL2_MCU_DFD_EN_SHIFT			(7)
#define MTK_WDT_LATCH_CTL2_MCU_DFD_EN_MASK \
	(0x1 << MTK_WDT_LATCH_CTL2_MCU_DFD_EN_SHIFT)
#define MTK_WDT_LATCH_CTL2_DVFSRC_LATCH_SELECT_SHIFT	(20)
#define MTK_WDT_LATCH_CTL2_DVFSRC_LATCH_SELECT_MASK \
	(0x1 << MTK_WDT_LATCH_CTL2_DVFSRC_LATCH_SELECT_SHIFT)
#define MTK_WDT_LATCH_CTL2_EMI_LATCH_SELECT_SHIFT		(21)
#define MTK_WDT_LATCH_CTL2_EMI_LATCH_SELECT_MASK \
	(0x1 << MTK_WDT_LATCH_CTL2_EMI_LATCH_SELECT_SHIFT)
#define MTK_WDT_LATCH_CTL2_MCU_LATCH_SELECT_SHIFT		(22)
#define MTK_WDT_LATCH_CTL2_MCU_LATCH_SELECT_MASK \
	(0x1 << MTK_WDT_LATCH_CTL2_MCU_LATCH_SELECT_SHIFT)
#define MTK_WDT_LATCH_CTL2_SPM_LATCH_SELECT_SHIFT		(23)
#define MTK_WDT_LATCH_CTL2_SPM_LATCH_SELECT_MASK \
	(0x1 << MTK_WDT_LATCH_CTL2_SPM_LATCH_SELECT_SHIFT)
