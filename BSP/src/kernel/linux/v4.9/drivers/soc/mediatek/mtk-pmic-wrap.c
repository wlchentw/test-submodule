...
static int pwrap_mt8518_init_reg_clock(struct pmic_wrapper *wrp)
{
	pwrap_writel(wrp, 0x2, PWRAP_RDDMY);
	pwrap_writel(wrp, 0x5, PWRAP_CSHEXT_WRITE);
	pwrap_writel(wrp, 0x5, PWRAP_CSHEXT_READ);
...
static int pwrap_init(struct pmic_wrapper *wrp)
{
	...
	/*set 0x1000F0AC[30]=1 for CK normal work*/
#if defined(CONFIG_MACH_MT8518)
	rdata = pwrap_readl(wrp, PWRAP_INT_EN);
	pwrap_writel(wrp, (rdata | (0x1 << 30)), PWRAP_INT_EN);
#endif
...
static struct pmic_wrapper_type pwrap_mt8518 = {
	.regs = mt8518_regs,
	.type = PWRAP_MT8518,
	.arb_en_all = 0xff,
	.int_en_all = ~(u32)(BIT(31) | BIT(2)),
	...
	.has_bridge = 0,
	.slv_switch = 1,
	.init_reg_clock = pwrap_mt8518_init_reg_clock,
};
