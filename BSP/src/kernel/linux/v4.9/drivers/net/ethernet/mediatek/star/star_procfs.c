...
static int get_wol_status(struct seq_file *seq, void *v)
{
	...
	STAR_PR_INFO("Use 'echo 0 > /proc/driver/star/wol' WOL_NONE\n");
	STAR_PR_INFO("Use 'echo 1 > /proc/driver/star/wol' MAC_WOL\n");
	STAR_PR_INFO("Use 'echo 2 > /proc/driver/star/wol' PHY_WOL\n");
