...
#define ARRAY_SIZE_EX(a) (sizeof(a)/sizeof(a[0]))

unsigned char gbLm3630_FL_W_percent_dutyA[] = {
...
unsigned char gbLm3630_FL_percent_table1[] = {
...
static LedPercent lm3630a_FL_W_duty_table[] = {
	{1 /* TABLE0 */,0,0},
	{2 /* TABLE0+ */,gbLm3630_FL_W_percent_dutyA,ARRAY_SIZE_EX(gbLm3630_FL_W_percent_dutyA)},
	{4 /* TABLE1+ */,gbLm3630_FL_percent_table1,ARRAY_SIZE_EX(gbLm3630_FL_percent_table1)},
};
...
unsigned char *lm3630a_get_FL_W_duty_table(int iFL_table_idx,int *O_piTableSize) 
{
	...
	int i;
	for(i=0;i<ARRAY_SIZE_EX(lm3630a_FL_W_duty_table);i++)
	{
...
int lm3630a_get_default_power_by_table(int iFL_table_idx,unsigned char *O_pbPower)
{
	...
	for(i=0;i<ARRAY_SIZE_EX(lm3630a_FL_power_table);i++)
	{
	...
	if(i>=ARRAY_SIZE_EX(lm3630a_FL_power_table)) {
...
int lm3630a_set_FL_W_duty_table(int iFL_table_idx,int I_iTableSize,unsigned char *I_pbFL_DutyTab)
{
	...
	if(i>=ARRAY_SIZE_EX(lm3630a_FL_W_duty_table)) {
		iRet=-1;
	}
