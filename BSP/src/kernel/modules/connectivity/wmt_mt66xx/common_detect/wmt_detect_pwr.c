...
static int wmt_detect_dump_pin_conf(void)
{
	...
	if (gpio_ctrl_info.gpio_ctrl_state[GPIO_COMBO_BGF_EINT_PIN].gpio_num !=
	    INVALID_PIN_ID) {
		WMT_DETECT_PR_INFO(
			"RST(GPIO%d), BGF_EINT(GPIO%d), BGF_EINT_NUM(%d)\n",
		...
		WMT_DETECT_PR_INFO(
			"RST(GPIO%d), BGF_EINT(GPIO%d)\n",
			gpio_ctrl_info.gpio_ctrl_state[GPIO_COMBO_RST_PIN].gpio_num,
			gpio_ctrl_info.gpio_ctrl_state[GPIO_COMBO_BGF_EINT_PIN].gpio_num);
	}

	if (gpio_ctrl_info.gpio_ctrl_state[GPIO_WIFI_EINT_PIN].gpio_num !=
	    INVALID_PIN_ID) {
		WMT_DETECT_PR_INFO(
			"WIFI_EINT(GPIO%d), WIFI_EINT_NUM(%d)\n",
		...
		WMT_DETECT_PR_INFO("WIFI_EINT(GPIO%d)\n",
			gpio_ctrl_info.gpio_ctrl_state[GPIO_WIFI_EINT_PIN].gpio_num);
	}
