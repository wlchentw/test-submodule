...
int32_t wifi_reset_end(enum ENUM_RESET_STATUS status)
{
	...
	#if 0
	//willcai
	typedef int (*mtk_wcn_wmt_fp_on) (int type);
	mtk_wcn_wmt_fp_on mtk_wcn_wmt_func1_on =
			(mtk_wcn_wmt_fp_on)kallsyms_lookup_name("mtk_wcn_wmt_func_on");
	if (mtk_wcn_wmt_func1_on == 0)
		{
