...
#include "../cfgfileinc/CFG_XoCap_File.h"
...
const TCFG_FILE g_akCFG_File_Custom[]= {
    ...
    {
        "/data/nvram/APCFG/APRDEB/XOCAP",	    	VER(AP_CFG_CUSTOM_FILE_XOCAP_LID),		    CFG_FILE_XOCAP_REC_SIZE,
        CFG_FILE_XOCAP_REC_TOTAL,		    	SIGNLE_DEFUALT_REC,				    (char *)&stXoCapDefault, DataReset , NULL
    },
	{
...
int iFileETHLID=AP_CFG_RDED_ETHERNET_CUSTOM_LID;
