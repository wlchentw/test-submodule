...
INCLUDES += \
    ...
    -I$(LOCAL_DIR)/../dpframework_prot/include/mt8183 \
    -I$(LOCAL_DIR)/include \
    -I$(LOCAL_DIR)/include/mt8183 \
    -I$(LOCAL_DIR)/MDP2.0/platform/mt8183/hardware \
    -I$(LOCAL_DIR)/MDP2.0/platform/mt8183 \
    -I$(LOCAL_DIR)/MDP2.0/platform/mt8183/engine \
    ...
    -I$(LOCAL_DIR)/MDP2.0/engine \
    -I$(LOCAL_DIR)/MDP2.0/engine/isp/isp8183 \
    -I$(LOCAL_DIR)/MDP2.0/engine/rsz/rsz8183 \
    ...
    -I$(LOCAL_DIR)/../../kernel-headers/mt8183 \
...
INCLUDES += \
    -I$(LOCAL_DIR)/MDP2.0/engine/tdshp/tdshp6752 \
...
MDP_LIB_OBJS  += \
    ...
    $(LOCAL_DIR)/MDP2.0/engine/isp/isp8183/DpWrapper_ISP.o \
    $(LOCAL_DIR)/MDP2.0/engine/isp/isp8183/DpWrapper_WPE.o \
...
ifeq ($(PQ_SUPPORT), 1)
MDP_LIB_OBJS  += \
    $(LOCAL_DIR)/MDP2.0/engine/tdshp/tdshp6752/DpEngine_TDSHP.o
endif

# Platform dependent part
MDP_LIB_OBJS  += \
    $(LOCAL_DIR)/MDP2.0/platform/mt8183/composer/DpPathTopology.o \
    $(LOCAL_DIR)/MDP2.0/platform/mt8183/engine/DpEngineMutex.o \
    $(LOCAL_DIR)/MDP2.0/platform/mt8183/engine/DpPathConnectionPlatform.o \
    $(LOCAL_DIR)/MDP2.0/platform/mt8183/engine/DpESLControl.o

# mdp library interface for mdpd
MDP_LIB_OBJS  += \
    $(LOCAL_DIR)/../if/mt8183/mdp_lib_if.o