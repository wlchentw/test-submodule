...
#define MDP_TILE_FUNC_ID_ENUM_DECLARE \
    ...
    TILE_FUNC_RDMA0_ID = TILE_FUNC_MDP_BASE,\
    TILE_FUNC_GAMMA_ID,\
    TILE_FUNC_DTH_ID,\
    TILE_FUNC_PRZ0_ID,\
    TILE_FUNC_TDSHP0_ID,\
    ...
    TILE_FUNC_PRZ1_ID,\
    TILE_FUNC_COLOR0_ID,\
    TILE_FUNC_PATH0_SOUT_ID,\
    TILE_FUNC_PATH1_SOUT_ID,\
    TILE_FUNC_WDMA_ID,\
...
#define MDP_TILE_HW_REG_LUT(CMD, a, b, c, d, e) \
    ...
    CMD(a, b, c, d, e, int, enable_MDP_PATH0_SOUT,, PATH0_SOUT_EN,,,,,, enable_MDP_PATH0_SOUT,,)\
    CMD(a, b, c, d, e, int, enable_MDP_PATH1_SOUT,, PATH1_SOUT_EN,,,,,, enable_MDP_PATH1_SOUT,,)\
    CMD(a, b, c, d, e, int, enable_MDP_WROT0,, WROT0_EN,,,,,, enable_MDP_WROT0,,)\
    CMD(a, b, c, d, e, int, enable_MDP_WDMA,, WDMA_EN,,,,,, enable_MDP_WDMA,,)\
    CMD(a, b, c, d, e, int, enable_MDP_GAMMA,, GAMMA_EN,,,,,, enable_MDP_GAMMA,,)\
    CMD(a, b, c, d, e, int, enable_MDP_DTH,, DTH_EN,,,,,, enable_MDP_DTH,,)\
    /*CMD(a, b, c, d, e, int, enable_TO_RSZ,, TO_RSZ_EN,,,,,, enable_TO_RSZ,,)*/\
    /*CMD(a, b, c, d, e, int, enable_TO_WROT,, TO_WROT_EN,,,,,, enable_TO_WROT,,)*/\
    /* MUX - mout */\
    CMD(a, b, c, d, e, int, DISP_isp_mout_en, MMSYS_ISP_MOUT_EN, CAMIN_OUT,,,,,, DISP_isp_mout_en,,)\
    CMD(a, b, c, d, e, int, DISP_isp2_mout_en, MMSYS_ISP2_MOUT_EN, CAMIN2_OUT,,,,,, DISP_isp2_mout_en,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_rdma0_mout_en, MMSYS_MDP_RDMA0_MOUT_EN, RDMA0_OUT,,,,,, DISP_mdp_rdma0_mout_en,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_aal0_mout_en, MMSYS_MDP_AAL0_MOUT_EN, AAL0_OUT,,,,,, DISP_mdp_aal0_mout_en,,)\
    ...
    CMD(a, b, c, d, e, int, DISP_mdp_gamma_mout_en, MMSYS_MDP_GAMMA_MOUT_EN, GAMMA_OUT,,,,,, DISP_mdp_gamma_mout_en,,)\
    /* MUX - sel in */\
    CMD(a, b, c, d, e, int, DISP_mdp_aal0_sel, MMSYS_MDP_AAL0_SEL_IN, AAL0_SEL,,,,,, DISP_mdp_aal0_sel,,)\
    ...
    CMD(a, b, c, d, e, int, DISP_mdp_path0_sel, MMSYS_MDP_PATH0_SEL_IN, PATH0_SEL,,,,,, DISP_mdp_path0_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_path1_sel, MMSYS_MDP_PATH1_SEL_IN, PATH1_SEL,,,,,, DISP_mdp_path1_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_wrot0_sel, MMSYS_MDP_WROT0_SEL_IN, WROT0_SEL,,,,,, DISP_mdp_wrot0_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_wdma_sel, MMSYS_MDP_WDMA_SEL_IN, WDMA_SEL,,,,,, DISP_mdp_wdma_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_dth_sel, MMSYS_MDP_DTH_SEL_IN, DTH_SEL,,,,,, DISP_mdp_dth_sel,,)\
    /*CMD(a, b, c, d, e, int, DISP_disp_wdma0_sel, MMSYS_DISP_WDMA0_SEL_IN, DISP_WDMA0_SEL,,,,,, DISP_disp_wdma0_sel,,)*/\
    /* MUX - sel out */\
    CMD(a, b, c, d, e, int, DISP_mdp_ccorr0_sout, MMSYS_MDP_CCORR0_SOUT_SEL, CCORR0_SOUT,,,,,, DISP_mdp_ccorr0_sout,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_path0_sout, MMSYS_MDP_PATH0_SOUT_SEL, PATH0_SOUT,,,,,, DISP_mdp_path0_sout,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_path1_sout, MMSYS_MDP_PATH1_SOUT_SEL, PATH1_SOUT,,,,,, DISP_mdp_path1_sout,,)\
    /*CMD(a, b, c, d, e, int, DISP_disp_to_wrot_sout, MMSYS_DISP_TO_WROT_SOUT_SEL, TO_WROT_SOUT,,,,,, DISP_disp_to_wrot_sout,,)*/\
...
#define GAMMA_TILE_WIDTH    (2560)
#define GAMMA_MIN_WIDTH     (32)
#define DTH_TILE_WIDTH      (2560)
#define DTH_MIN_WIDTH       (32)
