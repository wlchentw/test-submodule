...
public:
    enum EVENT_TYPE_ENUM
    {
        ...
        RDMA0_FRAME_START = 256,//CMDQ_EVENT_MDP_RDMA0_SOF,
        RSZ0_FRAME_START = 257,//CMDQ_EVENT_MDP_RSZ0_SOF,
        TDSHP0_FRAME_START = 258,//CMDQ_EVENT_MDP_TDSHP0_SOF,
        WROT0_FRAME_START = 259,//CMDQ_EVENT_MDP_WROT0_SOF,
        RDMA0_FRAME_DONE = 264,//CMDQ_EVENT_MDP_RDMA0_FRAME_DONE,
        WROT0_FRAME_DONE = 267,//CMDQ_EVENT_MDP_WROT0_WRITE_DONE,
        // GPR tokens
...
#if PMQOS_SETTING
    virtual mdp_pmqos* getMdpPmqos() = 0;
#endif
#ifdef CMDQ_V3
    virtual bool hasIspSecMeta() = 0;

    virtual cmdqSecIspMeta getSecIspMeta() = 0;
#endif
};
