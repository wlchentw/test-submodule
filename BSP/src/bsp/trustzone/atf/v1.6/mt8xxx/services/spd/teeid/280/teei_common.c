...
const char *teei_smc_call_id_to_string(uint32_t id)
{
	static const char *smc_str = "undefined";
		...
		case T_GET_ANDROID_VERSION:
			return "T_GET_ANDROID_VERSION";
		case T_SET_DRM_INT:
			return "T_SET_DRM_INT";
		case T_CLR_DRM_INT:
			return "T_CLR_DRM_INT";
		case T_GET_RAND_SEED:
			return "T_GET_RAND_SEED";
		case T_SW_GENERATE_INT:
			return "T_SW_GENERATE_INT";
		case T_SET_DRM_PPI:
			return "T_SET_DRM_PPI";
		case T_CLR_DRM_PPI:
			return "T_CLR_DRM_PPI";
		case N_GET_T_FP_DEVICE_ID:
			return "N_GET_T_FP_DEVICE_ID";
		case N_GET_SE_OS_STATE:
			return "N_GET_SE_OS_STATE";
		case N_GET_T_FP_DEVICE_ID_32:
			return "N_GET_T_FP_DEVICE_ID_32";
		}
