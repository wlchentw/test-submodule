...
#define MTK_I2C0_GIC_IRQ 55
#define MTK_I2C1_GIC_IRQ 159
#define MTK_I2C2_GIC_IRQ 149


#define MTK_I2C_CLK_SET  (IO_PHYS + 0x00010C0)
#define MTK_I2C_CLK_CLR  (IO_PHYS + 0x00010C4)
#define MTK_I2C_CLK_STA  (IO_PHYS + 0x00010C8)
#define MTK_I2C_CLK_TOP_STA  (IO_PHYS + 0x00000A0)
#define MTK_I2C_CLK_TOP_SET  (IO_PHYS + 0x00000A4)
#define MTK_I2C_CLK_TOP_CLR  (IO_PHYS + 0x00000A8)
