...
#define PCM_SUSPEMD_DPIDLE_CMD	0x50d10000
#define PCM_MCDI_CMD			0xBEEF0000
#define PCM_DVFS_INI_CMD		0xABCD0000
#define PCM_BYPASS_ALL_CMD		0xDCBA0000
...
struct pwr_ctrl {
	...
	uint32_t pcm_flags2;
	uint32_t pcm_flags2_cust;	/* can override pcm_flags2 */
	uint32_t pcm_flags2_cust_set;	/* set bit of pcm_flags2, after pcm_flags2_cust */
	uint32_t pcm_flags2_cust_clr;	/* clr bit of pcm_flags2, after pcm_flags2_cust */
	...
	uint32_t mmsys_oth_idle_mask;
	uint32_t image0_idle_mask;		/* IMAGE */
	uint32_t image1_idle_mask;
	uint32_t image_oth_idle_mask;
...
enum pwr_ctrl_enum {
	...
	PWR_MMSYS_OTH_IDLE_MASK,
	PWR_IMAGE0_IDLE_MASK,
	PWR_IMAGE1_IDLE_MASK,
	PWR_IMAGE_OTH_IDLE_MASK,
	PWR_INFRA1_IDLE_RG,
	PWR_INFRA0_IDLE_RG,
	PWR_INFRA2_IDLE_RG,
	PWR_INFRA3_IDLE_RG,
	PWR_INFRA4_IDLE_RG,
	PWR_MMSYS0_IDLE_RG,
	PWR_MMSYS_OTH_IDLE_RG,
	PWR_IMAGE0_IDLE_RG,
	PWR_IMAGE1_IDLE_RG,
	PWR_IMAGE_OTH_IDLE_RG,
	PWR_LOG_EN,
	/* 26M MODE SELECT */
...
extern uint32_t __spm_get_xo_type(void);
extern void __spm_set_xo_type_ctrl(struct pwr_ctrl *pwrctrl);
