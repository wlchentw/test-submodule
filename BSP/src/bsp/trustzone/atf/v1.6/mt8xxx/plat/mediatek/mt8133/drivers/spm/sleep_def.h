...
#define SPM_FLAG1_SWITCH_TO_ULPLL             (1U << 23)
#define SPM_FLAG1_DIS_SYSPLL_OFF              (1U << 24)
#define SPM_FLAG1_DIS_VCORE_SRAM_CONTROL      (1U << 25)
...
#define SPM_DBG_DEBUG_IDX_VCORE_DVFS_START	(1U << 10)
#define SPM_DBG_DEBUG_IDX_DDREN2_WAKE		(1U << 11)
#define SPM_DBG_DEBUG_IDX_DDREN2_SLEEP		(1U << 12)
#define SPM_DBG_DEBUG_IDX_CPU_RST_ONLY		(1U << 14)
#define SPM_DBG_DEBUG_IDX_ABORT			(1U << 15)
#define SPM_DBG_DEBUG_IDX_CPU_PDN		(1U << 16)
#define SPM_DBG_DEBUG_IDX_CPU_ON		(1U << 17)
#define SPM_DBG_DEBUG_IDX_CPUTOP_PDN		(1U << 18)
#define SPM_DBG_DEBUG_IDX_CPUTOP_ON		(1U << 19)
#define SPM_DBG_DEBUG_IDX_MCU_PDN		(1U << 20)
#define SPM_DBG_DEBUG_IDX_MCU_ON		(1U << 21)
