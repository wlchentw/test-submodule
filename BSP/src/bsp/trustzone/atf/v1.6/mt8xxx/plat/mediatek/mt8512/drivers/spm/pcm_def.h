...
#define R12_KP_F32K_WAKEUP_EVENT_2_1          (1U << 2)
#define R12_WDT_32K_EVENT_B                   (1U << 3)
#define R12_APXGPT_EVENT_B                    (1U << 4)
#define R12_CONN2AP_WAKEUP_B                  (1U << 5)
#define R12_EINT_EVENT_B                      (1U << 6)
#define R12_IRRX_WAKEUP                       (1U << 8)
#define R12_DSP_TIMER_EVENT_B                 (1U << 11)
#define R12_DSP_WAKEUP_B                      (1U << 12)
#define R12_WDT_WAKEUP_EVENT_B                (1U << 13)
#define R12_USB_POWERDWN_B                    (1U << 15)
#define R12_SYS_TIMER_EVENT_B                 (1U << 16)
#define R12_EINT_SECURE                       (1U << 17)
#define R12_NIC_IRQ                           (1U << 18)
#define R12_UART0_IRQ_B                       (1U << 19)
#define R12_AFE_IRQ_MCU_B                     (1U << 20)
#define R12_THERM_CTRL_EVENT_B                (1U << 21)
#define R12_MSDC2_WAKEUP                      (1U << 23)
#define R12_CSYSPWREQ_B                       (1U << 24)
#define R12_SEJ                               (1U << 27)
/* --- R12ext Define --- */
...
enum SPM_WAKE_SRC_LIST {
	...
	WAKE_SRC_R12_KP_F32K_WAKEUP_EVENT_2_1 = (1U << 2),
	WAKE_SRC_R12_WDT_32K_EVENT_B = (1U << 3),
	WAKE_SRC_R12_APXGPT_EVENT_B = (1U << 4),
	WAKE_SRC_R12_CONN2AP_WAKEUP_B  = (1U << 5),
	WAKE_SRC_R12_EINT_EVENT_B = (1U << 6),
	WAKE_SRC_R12_CONN_WDT_IRQ = (1U << 7),
	WAKE_SRC_R12_IRRX_WAKEUP = (1U << 8),
	WAKE_SRC_R12_LOW_BATTERY_IRQ_B = (1U << 9),
	WAKE_SRC_R12_DSP_TIMER_EVENT_B = (1U << 11),
	WAKE_SRC_R12_DSP_WAKEUP_B = (1U << 12),
	WAKE_SRC_R12_PCM_WDT_WAKEUP_B = (1U << 13),
	WAKE_SRC_R12_USB_CONNECT = (1U << 14),
	WAKE_SRC_R12_USB_POWERDWN_B = (1U << 15),
	WAKE_SRC_R12_SYS_TIMER_EVENT_B = (1U << 16),
	WAKE_SRC_R12_EINT_SECURE = (1U << 17),
	WAKE_SRC_R12_NIC_IRQ = (1U << 18),
	WAKE_SRC_R12_UART0_IRQ_B = (1U << 19),
	WAKE_SRC_R12_AFE_IRQ_MCU_B = (1U << 20),
	WAKE_SRC_R12_THERM_CTRL_EVENT_B = (1U << 21),
	WAKE_SRC_R12_SYS_CIRQ_B = (1U << 22),
	WAKE_SRC_R12_DSPWDT_IRQ_B = (1U << 23),
	WAKE_SRC_R12_CSYSPWREQ_B = (1U << 24),
	WAKE_SRC_R12_MSDC2_WAKEUP = (1U << 25),
	WAKE_SRC_R12_SEJ = (1U << 27),
	WAKE_SRC_R12_CPU_IRQOUTS_AND = (1U << 29),
