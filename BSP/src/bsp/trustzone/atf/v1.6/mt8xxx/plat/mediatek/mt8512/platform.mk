...
PLAT_BL_COMMON_SOURCES += ${MTK_PLAT}/common/drivers/mcsi/mcsi.c				\
				...
				${MTK_PLAT_SOC}/drivers/i2c/mt_i2c_atf.c					\
				...
				${MTK_PLAT_SOC}/drivers/spm/mt_spm_mcdi.c		\
				${MTK_PLAT_SOC}/drivers/spm/mt_voltage_setting.c		\
				${MTK_PLAT_SOC}/drivers/spm/mt_spm_mc_dsr.c		\
				${MTK_PLAT_SOC}/drivers/crypto/crypto.c			\
				${MTK_PLAT_SOC}/drivers/crypto/msdc_crypto.c		\
				${MTK_PLAT_SOC}/drivers/spm/mt_spm_hotplug.c		\
				...
				${MTK_PLAT_SOC}/plat_mtk_cirq.c						\
				${MTK_PLAT_SOC}/drivers/uart/uart.c			\
				${MTK_PLAT_SOC}/drivers/pmic/bd71828.c			\
				${OEMS_SOURCES}
endif
...
#add 64M project support
ifeq (${ATF_SUPPORT_64M},yes)
$(eval $(call add_define,ATF_SUPPORT_64M))
endif
