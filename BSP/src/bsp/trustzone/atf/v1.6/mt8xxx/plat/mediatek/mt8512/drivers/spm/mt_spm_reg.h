...
#define APU_PWR_CON                    (SPM_BASE + 0x378)
...
#define AUDAFE_MTCMOS_EN_LSB                   (1U << 2)       /* 1b */
#define AUDSRC_MTCMOS_EN_LSB                   (1U << 6)       /* 1b */
...
#define SYSCLK1_SRC_MASK_B                  (1U << 27)      /* 7b */
...
#define MD_DDR_EN_0_DBC_LEN                 (1U << 9)       /* 10b */
#define MD_DDR_EN_1_DBC_LEN_LSB             (1U << 10)      /* 10b */
#define MD_DDR_EN_1_DBC_LEN                 (1U << 19)      /* 10b */
#define CONN_DDR_EN_DBC_LEN_LSB             (1U << 20)      /* 10b */
#define CONN_DDR_EN_DBC_LEN                 (1U << 29)      /* 10b */
...
#define PWR_STA_DISP                        (1U << 15)       /* 1b */
#define PWR_STA_IMG							(1U << 16)
...
#define SPM_CPU_PWRSTA_SHIFT (10)
