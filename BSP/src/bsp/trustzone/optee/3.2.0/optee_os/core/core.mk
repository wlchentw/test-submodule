...
ifeq ($(filter y, $(CFG_DYN_SHM_CAP) $(CFG_CORE_RESERVED_SHM)),)
...
# add MTK pseudo TA if exist
-include ../secure/pta/pta.mk
-include ../source/pta/pta.mk
