...
GCC_VER_GTE94 := $(shell echo `$(CROSS_COMPILE64)gcc -dumpfullversion | cut -f1-2 -d.` \>= 9.4 | bc )
$(info GCC_VER_GTE94 = $(GCC_VER_GTE94))
ifeq ($(GCC_VER_GTE94),1)
arm64-platform-cflags-generic += -mno-outline-atomics
endif
