...
//for new type key,
//We will start with RESERVED space to avoid conflict in future
typedef enum {
  WIDEVINE_ID = 0,
  MARLIN_ID,
  HDCP_1X_TX_ID,
...
#define SZ_DRMKEY_HEADER_SIZE (SZ_DRMKEY_ID+SZ_DRMKEY_TYPE+SZ_DRMKEY_SIZE+\
SZ_DRMKEY_ENC_SIZE+SZ_DRMKEY_CLEAR_IV+SZ_DRMKEY_RESERVED)
#define SZ_DRMKEY_SIG 16

//OPTEE CA INTERFACE

//call keymanager to get DRM KEY
