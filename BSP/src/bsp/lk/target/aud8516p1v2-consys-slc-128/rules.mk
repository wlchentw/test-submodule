...
NAND_BUF_ADDR           := 0xffff000015200000UL   
else
SCRATCH_ADDR            := 0x44000000
BL33_ADDR               := 0x41e00000
NAND_BUF_ADDR           := 0x47c00000
endif
SCRATCH_SIZE		:= 0x02800000 # 64M -> 40M for max rootfs 

MAX_TEE_DRAM_SIZE	:= 0x00200000 # 2M 
MAX_KERNEL_SIZE		:= 0x00C00000 # 12M  
