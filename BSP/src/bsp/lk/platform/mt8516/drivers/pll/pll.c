 ...
 *********************/
    /*
    Voltage 1.3V  for 1300Mhz
    Voltage 1.25V for 1196Mhz
    Voltage 1.20V for 1040Mhz
    Voltage 1.15V for 747.5Mhz
    Voltage 1.15V for 598Mhz */
    DRV_WriteReg32(ARMPLL_CON1, 0x810e6000);  // default 747.5 MHz
 ...
 * TOP CLKMUX
 *************/
    DRV_WriteReg32(CLK_MUX_SEL0, (DRV_Reg32(CLK_MUX_SEL0) & ~0x3fffbff7) | 0x2710bf24);
 ...
 *************/
    ...
    DRV_WriteReg32(CLR_CLK_GATING_CTRL1, 0x00000800);
 ...
 *************/
	...
	temp = DRV_Reg32(CLK_GATING_CTRL1);
	dprintf(CRITICAL, "CLK_GATING_CTRL1:%x\n", temp);
	DRV_WriteReg32(CLR_CLK_GATING_CTRL1, 0x00002000);
	dprintf(CRITICAL, "after set, CLK_GATING_CTRL1:%x\n", DRV_Reg32(CLK_GATING_CTRL1));

	dprintf(CRITICAL, "CLK_GATING_CTRL2:%x\n", DRV_Reg32(CLK_GATING_CTRL2));
