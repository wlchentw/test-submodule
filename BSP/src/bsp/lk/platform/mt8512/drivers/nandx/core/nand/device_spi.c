...
static struct device_spi spi_nand[] = {
	...
	{
		NAND_DEVICE("FS35ND04G",
			    NAND_PACK_ID(0xCD, 0xEC, 0x11, 0, 0, 0, 0, 0),
			    3, 0, 3, 3,
			    1, 1, 1, 4096, KB(128), KB(2), 64, 1,
			    &spi_cmds, &spi_addressing, &spi_status[0],
			    &spi_endurance, &spi_array_timing),
		{
			NAND_SPI_PROTECT(0xa0, 1, 2, 6),
	...
	{
		NAND_DEVICE("MX35LF4G24AD",
			    NAND_PACK_ID(0xC2, 0x35, 0x03, 0, 0, 0, 0, 0),
			    3, 0, 3, 3,
			    1, 1, 1, 2048, KB(256), KB(4), 256, 1,
			    &spi_cmds, &spi_addressing, &spi_status[0],
			    &spi_endurance, &spi_array_timing),
