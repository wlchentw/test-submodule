...
#ifndef _MT8512_REGISTER_H_
#define _MT8512_REGISTER_H_
...
#define Channel_A_PHY_NAO_BASE_ADDRESS      (IO_PHYS + 0x230000)
#define Channel_B_PHY_NAO_BASE_ADDRESS      (IO_PHYS + 0x235000)

#define Channel_A_PHY_AO_BASE_ADDRESS       (IO_PHYS + 0x228000)
#define Channel_B_PHY_AO_BASE_ADDRESS       (IO_PHYS + 0x236000)

#define Channel_A_PSRAM_AO_BASE_ADDRESS     (IO_PHYS + 0x232000)
#define Channel_A_PSRAM_NAO_BASE_ADDRESS    (IO_PHYS + 0x234000)
...
#define EMI_BWCT0_6TH       (EMI_APB_BASE + 0x7C8)
