...
//#define COMBO_MCP				// don't use COMBO_MCP
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            ...
            int   iLPDDRX_MODE_REG_5;
            int   iLPDDR3_MODE_REG_10;
            int   iLPDDR3_MODE_REG_63;
        };
    };
#else
    unsigned int   iLPDDRX_MODE_REG_5;
#endif
...
#if ! __ETT__
U32 mt_set_emis(U8* emi, U32 len, BOOL use_default); //array of emi setting.
#endif
#endif
...
#if LP4_MAX_2400
#define HQA_VCORE_HV_LP4_KOPP0	735000  /* PMIC accuracy 6.25mV, actual output voltage 731250 */
#define HQA_VCORE_HV_LP4_KOPP1	735000
#define HQA_VCORE_HV_LP4_KOPP2	735000
#define HQA_VCORE_HV_LP4_KOPP3	735000
#define HQA_VCORE_HV_LP4_KOPP4	682500  /* PMIC accuracy 6.25mV, actual output voltage 681250 */
#else
#define HQA_VCORE_HV_LP4_KOPP0	840000
#define HQA_VCORE_HV_LP4_KOPP1	840000
#define HQA_VCORE_HV_LP4_KOPP2	735000
#define HQA_VCORE_HV_LP4_KOPP3	680000
#define HQA_VCORE_HV_LP4_KOPP4	680000
#endif
#define HQA_VDRAM_HV_LP4        1155000  /* PMIC accuracy 25mV, actual output voltage 1150000 */
#define HQA_VDDQ_HV_LP4         1155000

#define HQA_VIO18_NV			1800000
#if LP4_MAX_2400
#define HQA_VCORE_NV_LP4_KOPP0	700000
...
#define HQA_VCORE_NV_LP4_KOPP2	700000
#define HQA_VCORE_NV_LP4_KOPP3	650000
#define HQA_VCORE_NV_LP4_KOPP4	650000
#endif
#define HQA_VDRAM_NV_LP4        1100000
#define HQA_VDDQ_NV_LP4         1100000

#define HQA_VIO18_LV			1710000

#if LP4_MAX_2400
#define HQA_VCORE_LV_LP4_KOPP0	665000  /* PMIC accuracy 6.25mV, actual output voltage 662500 */
#define HQA_VCORE_LV_LP4_KOPP1	665000
#define HQA_VCORE_LV_LP4_KOPP2	665000
#define HQA_VCORE_LV_LP4_KOPP3	665000
#define HQA_VCORE_LV_LP4_KOPP4	617500  /* PMIC accuracy 6.25mV, actual output voltage 612500 */
#else
#define HQA_VCORE_LV_LP4_KOPP0	760000
#define HQA_VCORE_LV_LP4_KOPP1	760000
#define HQA_VCORE_LV_LP4_KOPP2	665000
#define HQA_VCORE_LV_LP4_KOPP3	617500
#define HQA_VCORE_LV_LP4_KOPP4	617500
#endif

#if !__ETT__
#define HQA_VDRAM_LV_LP4        1045000  /* PMIC accuracy 25mV, actual output voltage 1025000 */
#define HQA_VDDQ_LV_LP4			1045000
#else
#define HQA_VDRAM_LV_LP4		1045000
#define HQA_VDDQ_LV_LP4			1045000
#endif
...
#define HQA_VCORE_HV_LP3_KOPP4	662500	// 682500
...
#define HQA_VDRAM_NV_LP3		1200000

#define HQA_VCORE_LV_LP3_KOPP0	750000	// 756250
#define HQA_VCORE_LV_LP3_KOPP1	750000	// 756250
#define HQA_VCORE_LV_LP3_KOPP2	650000	// 662500
#define HQA_VCORE_LV_LP3_KOPP3	650000	// 662500
#define HQA_VCORE_LV_LP3_KOPP4	650000	// 617500
...
#define	DRAM_CALIBRATION_DATA_MAGIC	0x8512
