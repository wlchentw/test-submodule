...
/* field macros */
#define Fld_old(wid,shft,ac)    (((U32)wid<<16)|(shft<<8)|ac)
#define Fld(wid,shft)   (((U32)(wid-shft)==32) ? Fld_old(wid,shft,AC_FULLDW) : (((U32)wid<<16)|(shft<<8)))
...
extern U32 u4Dram_Register_Read(U64 u4reg_addr); 
extern U8 ucDram_Register_Write(U64 u4reg_addr, U32 u4reg_value);

extern void vIO32Write4BMsk2(U64 reg32, U32 val32, U32 msk32);
extern void vIO32Write4BMsk_All2(U64 reg32, U32 val32, U32 msk32);
extern void vIO32Write4B_All2(U64 reg32, U32 val32);
...
#define vIO32Write4B_All(reg32, val32) vIO32Write4B_All2(reg32, val32)
#define vIO32Write4BMsk(reg32, val32, msk32) vIO32Write4BMsk2(reg32, val32, msk32)
#define vIO32Write4BMsk_All(reg32, val32, msk32) vIO32Write4BMsk_All2(reg32, val32, msk32)

#if SW_CHANGE_FOR_SIMULATION
extern U32 u4IO32ReadFldAlign2(U32 reg32, U32 fld);
extern void vIO32WriteFldAlign2(U32 reg32, U32 val, U32 fld);
extern void vIO32WriteFldAlign_All2(U32 reg32, U32 val, U32 fld);
#define u4IO32ReadFldAlign(reg32, fld)	u4IO32ReadFldAlign2(reg32, fld)
#define vIO32WriteFldAlign(reg32, val, fld)	vIO32WriteFldAlign2(reg32, val, fld)
#define vIO32WriteFldAlign_All(reg32, val, fld)	vIO32WriteFldAlign_All2(reg32, val, fld)
